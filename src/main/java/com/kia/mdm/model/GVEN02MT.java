...
public class GVEN02MT extends CommonObject implements Model {
	...
	private String repNm_KR                         = "";
	private String sellingAreaNm                    = "";
	private String legacyFrontOfficeAccountNo       = "";
	private String legacyBackOfficeAccountNo        = "";
	private String license                          = "";
	private String createDate                       = "";
	private String sellingAreaCreatedDate           = "";
	private String lastModifiedDate                 = "";
	private String sellingAreaLastModifiedDate      = "";
...
//	mail
	...
	private String[] sellingAreaIDs	              	 = null;
	private String[] refNos                          = null;
	private String[] customerIDs                     = null;
	private String[] customerNms                     = null;
	private String[] countrys                        = null;
	private String[] rageSphereCDs                   = null;
	private String[] teamCDs                         = null;
	private String[] repNms                          = null;
	private String[] repNm_KRs                       = null;
	private String[] sellingAreaNms                  = null;
	private String[] legacyFrontOfficeAccountNos     = null;
	private String[] legacyBackOfficeAccountNos      = null;
	private String[] licenses                        = null;
	private String[] createDates                     = null;
	private String[] sellingAreaCreatedDates           = null;
	private String[] lastModifiedDates                 = null;
	private String[] sellingAreaLastModifiedDates      = null;
	private String[] lastModifiedBys                 = null;
	...
	public int getSize_Admin() {
		int size = 0 ;
		
		if (this.sellingAreaIDs != null) {
			 size = this.sellingAreaIDs.length;
		}
		return size;
	}
	
	public int getSize_Admin_Del() {
		int size = 0 ;
	...
	//신규 엑셀 업로드
	public GVEN02MT getObject(int index) {
		GVEN02MT vo = new GVEN02MT();
		if (getSize() > index) {
			...
			try{vo.setFascia(this.fascias[index]);}catch(Exception e){}
	...
	public GVEN02MT getObject_request(int index) {
		GVEN02MT vo = new GVEN02MT();
		if (getSize() > index) {
			try{vo.setEmpID(this.getEmpID());}catch(Exception e){}
	...
	public GVEN02MT getObject_remove(int index) {
		GVEN02MT vo = new GVEN02MT();
		if (getSize() > index) {
			try{vo.setEmpID(this.getEmpID());}catch(Exception e){}
			try{vo.setVenueCD(this.venueCDs[index]);}catch(Exception e){}
	...
	//승인
	public GVEN02MT getObject_approval(int index) {
		GVEN02MT vo = new GVEN02MT();
	...
	//반려
	public GVEN02MT getObject_reject(int index) {
		GVEN02MT vo = new GVEN02MT();
	...
	public GVEN02MT getObject_Admin(int index) {
		GVEN02MT vo = new GVEN02MT();
		
		if (getSize_Admin() > index) 
			try{vo.setUserID(this.getUserID());}catch(Exception e){}{
			try{vo.setSellingAreaID(this.sellingAreaIDs[index]);}catch(Exception e){}
			try{vo.setCustomerID(this.customerIDs[index]);}catch(Exception e){}
			try{vo.setRefNo(this.refNos[index]);}catch(Exception e){}
			try{vo.setVenueCD(this.venueCDs[index]);}catch(Exception e){}
			try{vo.setCountry(this.countrys[index]);}catch(Exception e){}
			try{vo.setTerritoryCD(this.territoryCDs[index]);}catch(Exception e){}
			try{vo.setRageSphereCD(this.rageSphereCDs[index]);}catch(Exception e){}
			try{vo.setTeamCD(this.teamCDs[index]);}catch(Exception e){}
			try{vo.setRepNm(this.repNms[index]);}catch(Exception e){}
			try{vo.setRepNm_KR(this.repNm_KRs[index]);}catch(Exception e){}
			try{vo.setCustomerNm(this.customerNms[index]);}catch(Exception e){}
			try{vo.setSellingAreaNm(this.sellingAreaNms[index]);}catch(Exception e){}
			...
			try{vo.setFascia(this.fascias[index]);}catch(Exception e){}
			try{vo.setLegacyFrontOfficeAccountNo(this.legacyFrontOfficeAccountNos[index]);}catch(Exception e){}
			try{vo.setLegacyBackOfficeAccountNo(this.legacyBackOfficeAccountNos[index]);}catch(Exception e){}
			try{vo.setWs1CD(this.ws1CDs[index]);}catch(Exception e){}
			try{vo.setWs2CD(this.ws2CDs[index]);}catch(Exception e){}
			try{vo.setWs3CD(this.ws3CDs[index]);}catch(Exception e){}
			try{vo.setWs4CD(this.ws4CDs[index]);}catch(Exception e){}
			...
			try{vo.setWs3SapCD(this.ws3SapCDs[index]);}catch(Exception e){}
			try{vo.setWs4SapCD(this.ws4SapCDs[index]);}catch(Exception e){}
			try{vo.setLicense(this.licenses[index]);}catch(Exception e){}
			try{vo.setActiveYN(this.activeYNs[index]);}catch(Exception e){}
			try{vo.setCreateDate(this.createDates[index]);}catch(Exception e){}
			try{vo.setSellingAreaCreatedDate(this.sellingAreaCreatedDates[index]);}catch(Exception e){}
			try{vo.setLastModifiedDate(this.lastModifiedDates[index]);}catch(Exception e){}
			try{vo.setSellingAreaLastModifiedDate(this.sellingAreaLastModifiedDates[index]);}catch(Exception e){}
			try{vo.setLastModifiedBy(this.lastModifiedBys[index]);}catch(Exception e){}
			try{vo.setVenueDivCD(this.venueDivCDs[index]);}catch(Exception e){}
		}
		return vo;
	}
	
	public GVEN02MT getObject_Admin_Del(int index) {
		GVEN02MT vo = new GVEN02MT();
		
		if (getSize_Admin_Del() > index) 
			try{vo.setUserID(this.getUserID());}catch(Exception e){}{
			try{vo.setVenueCD(this.venueCDs[index]);}catch(Exception e){}
		}
		return vo;
	...
	public String[] getFascias() {
		return fascias;
	}

	public void setFascias(String[] fascias) {
	...
	public String getSellingAreaID() {
		return sellingAreaID;
	}

	public void setSellingAreaID(String sellingAreaID) {
	...
	public String getLegacyFrontOfficeAccountNo() {
		return legacyFrontOfficeAccountNo;
	}

	public void setLegacyFrontOfficeAccountNo(String legacyFrontOfficeAccountNo) {
		this.legacyFrontOfficeAccountNo = legacyFrontOfficeAccountNo;
	}

	public String getLegacyBackOfficeAccountNo() {
		return legacyBackOfficeAccountNo;
	}

	public void setLegacyBackOfficeAccountNo(String legacyBackOfficeAccountNo) {
		this.legacyBackOfficeAccountNo = legacyBackOfficeAccountNo;
	}
	...
	public String getSellingAreaCreatedDate() {
		return sellingAreaCreatedDate;
	}

	public void setSellingAreaCreatedDate(String sellingAreaCreatedDate) {
		this.sellingAreaCreatedDate = sellingAreaCreatedDate;
	}
	...
	public String getSellingAreaLastModifiedDate() {
		return sellingAreaLastModifiedDate;
	}

	public void setSellingAreaLastModifiedDate(String sellingAreaLastModifiedDate) {
		this.sellingAreaLastModifiedDate = sellingAreaLastModifiedDate;
	}
	...
	public String[] getSellingAreaIDs() {
		return sellingAreaIDs;
	}

	public void setSellingAreaIDs(String[] sellingAreaIDs) {
		this.sellingAreaIDs = sellingAreaIDs;
	}
	...
	public String[] getLegacyFrontOfficeAccountNos() {
		return legacyFrontOfficeAccountNos;
	}

	public void setLegacyFrontOfficeAccountNos(String[] legacyFrontOfficeAccountNos) {
		this.legacyFrontOfficeAccountNos = legacyFrontOfficeAccountNos;
	}

	public String[] getLegacyBackOfficeAccountNos() {
		return legacyBackOfficeAccountNos;
	}

	public void setLegacyBackOfficeAccountNos(String[] legacyBackOfficeAccountNos) {
		this.legacyBackOfficeAccountNos = legacyBackOfficeAccountNos;
	}
	...
	public String[] getSellingAreaCreatedDates() {
		return sellingAreaCreatedDates;
	}

	public void setSellingAreaCreatedDates(String[] sellingAreaCreatedDates) {
		this.sellingAreaCreatedDates = sellingAreaCreatedDates;
	}
	...
	public String[] getSellingAreaLastModifiedDates() {
		return sellingAreaLastModifiedDates;
	}

	public void setSellingAreaLastModifiedDates(String[] sellingAreaLastModifiedDates) {
		this.sellingAreaLastModifiedDates = sellingAreaLastModifiedDates;
	}

	public String[] getLastModifiedBys() {
		return lastModifiedBys;
	}

	public void setLastModifiedBys(String[] lastModifiedBys) {
		this.lastModifiedBys = lastModifiedBys;
	}
	...
	public String getRepNm_KR() {
		return repNm_KR;
	}

	public void setRepNm_KR(String repNm_KR) {
		this.repNm_KR = repNm_KR;
	}

	public String getSellingAreaNm() {
		return sellingAreaNm;
	}

	public void setSellingAreaNm(String sellingAreaNm) {
		this.sellingAreaNm = sellingAreaNm;
	}

	public String[] getCustomerNms() {
		return customerNms;
	}

	public void setCustomerNms(String[] customerNms) {
		this.customerNms = customerNms;
	}

	public String[] getRepNms() {
		return repNms;
	}

	public void setRepNms(String[] repNms) {
		this.repNms = repNms;
	}

	public String[] getRepNm_KRs() {
		return repNm_KRs;
	}

	public void setRepNm_KRs(String[] repNm_KRs) {
		this.repNm_KRs = repNm_KRs;
	}

	public String[] getSellingAreaNms() {
		return sellingAreaNms;
	}

	public void setSellingAreaNms(String[] sellingAreaNms) {
		this.sellingAreaNms = sellingAreaNms;
	}
