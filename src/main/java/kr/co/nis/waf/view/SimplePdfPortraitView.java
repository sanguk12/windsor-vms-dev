...
public class SimplePdfPortraitView extends AbstractPdfView
{
    protected final Log logger;
    private BaseFont bf;
    private Font font;
    
    public SimplePdfPortraitView() {
    ...
    protected Document newDocument() {
        final Document doc = new Document(PageSize.A4, 50.0f, 50.0f, 50.0f, 50.0f);
        return doc;
    }
