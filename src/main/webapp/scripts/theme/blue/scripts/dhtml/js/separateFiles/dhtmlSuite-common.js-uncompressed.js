...
if(!window.DHTML_SUITE_THEME_FOLDER)var DHTML_SUITE_THEME_FOLDER=_contextPath+'/scripts/theme/blue/scripts/dhtml/themes/';
if(!window.DHTML_SUITE_JS_FOLDER)var DHTML_SUITE_JS_FOLDER=_contextPath+'/scripts/theme/blue/scripts/dhtml/js/separateFiles/';
