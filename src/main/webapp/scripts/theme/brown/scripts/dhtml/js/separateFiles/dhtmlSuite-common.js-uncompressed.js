...
if(!window.DHTML_SUITE_THEME_FOLDER)var DHTML_SUITE_THEME_FOLDER=_contextPath+'/scripts/theme/brown/scripts/dhtml/themes/';
if(!window.DHTML_SUITE_JS_FOLDER)var DHTML_SUITE_JS_FOLDER=_contextPath+'/scripts/theme/brown/scripts/dhtml/js/separateFiles/';
...
widgetDep['calendar']=['dhtmlSuite-calendar.js-uncompressed.js','dhtmlSuite-dragDropSimple.js'];
