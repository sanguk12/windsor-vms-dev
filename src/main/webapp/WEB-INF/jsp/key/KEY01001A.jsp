					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
		            	<tr>
		                    <td height="1">
								...
								<input type="hidden" id="appSrc" name="appSrc" value="${contextPath}/service/simpleCommand/?mnuGrpID=${params.mnuGrpID}&pgmID=${params.pgmID}&viewID=KEY01001B" />
								<input type="hidden" id="appSrc2" name="appSrc2" value="${contextPath}/service/simpleCommand/?mnuGrpID=${params.mnuGrpID}&pgmID=${params.pgmID}&viewID=KEY01001C" />
							</td>
						</tr>
						<tr>
							<td height="1">
											...
											<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
								        		...
								        		<tbody>
						                            <tr>
						                                ...
						                                <td class="td-cond">
															<fmt:message key="KEY01001A.addrTpCD2" />
														</td>
														<td class="td-input">
											...
											<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
						                   		<tr>
						                   			<td class="tit_text01" height="20" valign="top">
														&nbsp;<fmt:message key="KEY01001A.key01" />
													</td>
						                   		</tr>
						                   		<tr>
						                   			<td>
												...
												<tr>
						                   			<td class="tit_text01" height="20" valign="top">
														&nbsp;<fmt:message key="KEY01001A.key02" />
													</td>
						                   		</tr>
												<tr>
													<td>
...
<script type="text/javascript">
	...
	****************************************/
	...
	function Search() {	// 첫번째 그리드 
		...
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/KEY0100101S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
...
// 	  	if (grid != null) grid.clear();
	...
	function Search_key01() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/KEY0100102S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
...
// 	  	if (grid_key01 != null) grid_key01.clear();
	...
	function Search_key02() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/KEY0100103S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
...
// 	  	if (grid_key02 != null) grid_key02.clear();
	...
	*****************************************************/
	var columns = [
       	"<fmt:message key="KEY01001A.venueCD"/>"
		, "<fmt:message key="KEY01001A.venueNm"/>"
		, "<fmt:message key="KEY01001A.venueGradCD"/>"
	...
	var columns_key01 = [
   	    "<fmt:message key="KEY01001A.keymanID"/>"
        , "<fmt:message key="KEY01001A.keymanNm"/>"
   		, "<fmt:message key="KEY01001A.keymanTpCD"/>"
   		, "<fmt:message key="KEY01001A.regIDNo"/>"
   		, "<fmt:message key="KEY01001A.addr"/>"
   		, "<fmt:message key="KEY01001A.phoneNo"/>"
   		, "<fmt:message key="KEY01001A.bankCD"/>"
   		, "<fmt:message key="KEY01001A.accountNo"/>"
   		, "<fmt:message key="KEY01001A.holderNm"/>"
   		, "<fmt:message key="KEY01001A.pKeymanYN"/>"
   		, "<fmt:message key="KEY01001A.activeYN"/>"
	...
	var columns_key02 = [
		"<fmt:message key="KEY01001A.requestDate"/>"
		, "<fmt:message key="KEY01001A.requestTpCD"/>"
		, "<fmt:message key="KEY01001A.keymanID"/>"
		, "<fmt:message key="KEY01001A.keymanNm"/>"
		, "<fmt:message key="KEY01001A.keymanTpCD"/>"
		, "<fmt:message key="KEY01001A.regIDNo"/>"
		...
		, "<fmt:message key="KEY01001A.holderNm"/>"
		, "<fmt:message key="KEY01001A.pKeymanYN"/>"
		, "<fmt:message key="KEY01001A.requestStateCD"/>"
	];
	var grid_key02 = null;
