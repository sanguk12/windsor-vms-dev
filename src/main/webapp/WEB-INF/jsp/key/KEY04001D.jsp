...
<html>
	...
	<body class="yui-skin-sam" ${bodyConfig} onload="">
...
<script language="javascript">
	...
	$(document).ready(function() {
		...
		window.onload = function() {
			...
			if("${params.docLinkID}" != "") {
				...
				$("#previewIdTd").append("<img src=${contextPath}/upload/"+"${params.fileUrl}"+"${params.UUID}"+" id='previewId' style='width: 99%; height: auto; padding-left: 5px; padding-top: 5px; padding-right: 5px; padding-bottom: 5px;'></img>");
			}
			Search();
	...
	function validationChk(){
		...
		if(docLinkID == '') {
			alert("<fmt:message key="KEY04001D.msg3"/>");
			isBoolean = false;
		}
        ...
        var rowCount = table.getCount();
      	if (rowCount == 1) {
   			...
   			if(table.getData(8,0) != "" && "${params.docLinkID}" == ""){
   				$("#previewIdTd").append("<img src=${contextPath}/upload/"+table.getData(9,0)+table.getData(10,0)+" id='previewId' style='width: 99%; height: auto; padding-left: 5px; padding-top: 5px; padding-right: 5px; padding-bottom: 5px;'></img>");
