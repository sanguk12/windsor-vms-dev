	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/KEY0100105S");
...
// 	  	if (grid != null) grid.clear();
	...
	*****************************************************/
	var columns = [
   		"<fmt:message key="KEY01001D.apprGrpNm"/>"
   		, "<fmt:message key="KEY01001D.empID"/>"
   		, "<fmt:message key="KEY01001D.empNm"/>"
   		, "<fmt:message key="KEY01001D.apprStateCD"/>"
   		, "<fmt:message key="KEY01001D.apprDate"/>"
   		, "<fmt:message key="KEY01001D.commt"/>"
	];
