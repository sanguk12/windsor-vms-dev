		                    			...
		                    			<td class="tb-border">
											<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
								        		...
								        		<tbody>
								        			<tr>
						                            	<td class="td-cond">
						                            		<fmt:message key="KEY03003F.depDocuStat" />
														</td>
...
<script language="javascript">
	...
	function ValidationCheck() {
		...
		if(DocFinshFl == 'Y') {
			alert("<fmt:message key="KEY03003F.msg1"/>");
			return;
			//isBoolean = false;
		}
		
		if(valexStatCd == '999') {
			alert("<fmt:message key="KEY03003F.msg4"/>");
			return;
			//isBoolean = false;
		}
		if($("#keymanPrgsCd").val() == ''){
			alert("<fmt:message key="KEY03003F.msg5"/>");
			$("#keymanPrgsCd").focus();
			return false;
		}
		return isBoolean;
...
<script type="text/javascript">
	...
	****************************************/
	...
	function Pdf() {
		if($("#docLinkID").val() == ""){
			alert("<fmt:message key="KEY03003F.msg3"/>");
			return;
		}
        ...
        document.getElementById("report").value = "KEY03003F";
	...
	function Search() {
        ...
        table.setParameter("wordType", "400");
        table.request();
        ...
        var rowCount = table.getCount();
      	if (rowCount == 1) {
   			...
   			if(table.getData(8,0) != ""){
   				$("#previewId").attr("src","/upload/"+table.getData(9,0)+table.getData(10,0));
   			}
