	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/KEY0100405S");
	  	...
	  	table.setParameter("format",
	  			"str;str;str;str;str;"+
	  			"str;");
	  	table.setParameter("keymanID", "${params.keymanID}");
	  	table.setParameter("requestDate", "${params.requestDate}");
	  	table.setParameter("requestSeq", "${params.requestSeq}");
	  	table.request();
...
// 	  	if (grid != null) grid.clear();
	...
	*****************************************************/
	var columns = [
   		"<fmt:message key="KEY01004D.apprGrpNm"/>"
   		, "<fmt:message key="KEY01004D.empID"/>"
   		, "<fmt:message key="KEY01004D.empNm"/>"
   		, "<fmt:message key="KEY01004D.apprStateCD"/>"
   		, "<fmt:message key="KEY01004D.apprDate"/>"
   		, "<fmt:message key="KEY01004D.commt"/>"
	];
