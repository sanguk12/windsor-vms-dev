								...
								<td height="1" valign="top">
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
										...
										<tbody>
											<tr>
												<td class="td-cond">
													<fmt:message key="KEY01004B.venueCD" />
												</td>
												<td class="td-cond" colspan="2">
													<fmt:message key="KEY01004B.venueNm" />
												</td>
												<td class="td-cond" >
													<fmt:message key="KEY01004B.keymanID" />
												</td>
												<td class="td-cond">
													<fmt:message key="KEY01004B.requestTpCD" />
												</td>
												<td class="td-cond">
												</td>
											</tr>
											...
											<tr>
												<td class="td-cond-required">
													<fmt:message key="KEY01004B.keymanNm" />
												</td>
<!-- 												<td class="td-cond-required"> -->
<!-- 													<fmt:message key="KEY01004B.keymanTpCD" /> -->
<!-- 												</td> -->
<!-- 												<td class="td-cond-required"> -->
<!-- 													<fmt:message key="KEY01004B.regIDNo" /> -->
<!-- 												</td> -->
												<td class="td-cond-required">
													<fmt:message key="KEY01004B.birthDate" />
												</td>
												<td class="td-cond-required">
													<fmt:message key="KEY01004B.dutyCD" />
												</td>
												<td class="td-cond-required">
													<fmt:message key="KEY01004B.PKeymanYN" />
												</td>
												<td class="td-cond" colspan="2">
												</td>
											</tr>
...
<!-- 												</td> -->
											...
											<tr>
												<td class="td-cond-required" colspan="3">
													<fmt:message key="KEY01004B.addr" />
												</td>
												<td class="td-cond-required">
													<fmt:message key="KEY01004B.phoneNo" />
												</td>
												<td class="td-cond" >
													<fmt:message key="KEY01004B.emailAddr" />
												</td>
												<td class="td-cond">
												</td>
											</tr>
											<tr>
												<td class="td-input-rborder" colspan="3">
													<input type="text" id="addr" name="addr" style="width:530px;" maxlength="250" />
												</td>
												<td class="td-input-rborder">
...
<!-- 											<tr> -->
<!-- 												<td class="td-cond"> -->
<!-- 													<fmt:message key="KEY01004B.bankCD" /> -->
<!-- 												</td> -->
<!-- 												<td class="td-cond"> -->
<!-- 													<fmt:message key="KEY01004B.accountNo" /> -->
<!-- 												</td> -->
<!-- 												<td class="td-cond"> -->
<!-- 													<fmt:message key="KEY01004B.holderNm" /> -->
<!-- 												</td> -->
<!-- 												<td class="td-cond"> -->
<!-- 													<fmt:message key="KEY01004B.requestDate" /> -->
<!-- 												</td> -->
<!-- 												<td class="td-cond"> -->
<!-- 												</td> -->
<!-- 											</tr> -->
...
<!-- 												</td> -->
<!-- 												<td class="td-input-rborder"> -->
<!-- 													<input type="text" id="holderNm" name="holderNm" style="width:180px;" maxlength="15" /> -->
<!-- 												</td> -->
<!-- 												<td class="td-input-rborder"> -->
<!-- 												</td> -->
<!-- 											</tr> -->
											<tr>
												<td class="td-cond" colspan="3">
													<fmt:message key="KEY01004B.note" />
												</td>
												<td class="td-cond">
													<fmt:message key="KEY01004B.requestStateCD" />
												</td>
												<td class="td-cond" >
													<fmt:message key="KEY01004B.requestDate" />
												</td>
											...
											<tr>
												<td class="td-input-rborder" colspan="3">
													<input type="text" id="note" name="note" style="width:530px;" maxlength="100" />
												</td>
												<td class="td-input-rborder">
												...
												<td class="td-input-rborder" >
													<input type="text" id="requestDate" name="requestDate" style="width:100px;" class="input-readonly" readonly />
												</td>
												<td class="td-input-rborder">
												</td>
											</tr>
											<tr>
												<td class="td-cond" colspan="4">
													<fmt:message key="KEY01004B.accreErrCommt" />
												</td>
												<td class="td-cond" >
													<fmt:message key="KEY01004B.accreDate" />
												</td>
												<td class="td-cond">
												</td>
											</tr>
...
<!-- 											</tr> -->
							...
							<tr>
								<td height="1">
									...
									<input type="hidden" id="apprTpID" name="apprTpID" value="000001" /><!-- Keyman관리 승인라인 -->
...
// 		});
		...
		$("#birthDate").on("focusout",function(){
			if($("#birthDate").val()!=""){
				if(unformat($("#birthDate").val()).length!=8){
					alert("<fmt:message key="KEY01004B.msg24"/>");
					$("#birthDate").val("");
					$("#birthDate").focus();
				}
			}
		...
		$("#keymanTypeCD").change(function(){
			if($("#keymanTypeCD").val()=="10"){
	    		...
	    		$("#birthDate").removeClass("input-readonly");
			}else{
				$("#birthDate").val("");
...
// 		var birthDate = unformat($("#regIDNo").val()).substring(0,6); 
		var birthDate = unformat($("#birthDate").val()).substring(0,8);
// 		unformat($("#birthDate").val()).substring(0,6);
		var yearFront = "";
...
// 		birthDate = yearFront+birthDate; //19950710
// 		$("#birthDate").val(formatDate(birthDate));
		
		
		//만나이 구하기
		var bday=parseInt(birthDate.substring(6,8)); //10 
		var bmo=(parseInt(birthDate.substring(4,6))-1); //07
		var byr=parseInt(birthDate.substring(0,4));  //1995
		var byr;
		var age;
		var now = new Date();
		tday=now.getDate();       //07
		tmo=(now.getMonth());     //05
		tyr=(now.getFullYear());   //2015
...
<script type="text/javascript">
	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/KEY0100404S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			"venueCD;venueNm;requestTpCD;keymanID;keymanNm;"+
	  			"keymanTypeCD;regIDNo;birthDate;dutyCD;addr;"+
	  			"phoneNo;emailAddr;bankCD;accountNo;holderNm;" + 
	  			"PkeymanYN;requestDate;note;requestStateCDName;accreErrCommt;"+
	  			"accreDate;requestSeq;requestStateCD;");
...
//       		$("#regIDNo").val(formatIDNo(table.getData(_col.regIDNo, 0), ""));
	...
	function openRequestState() {
		var url = "${contextPath}/service/simpleCommand/?mnuGrpID=${params.mnuGrpID}&pgmID=${params.pgmID}&viewID=KEY01004D"
				+"&keymanID="+$("#keymanID").val()
				+"&requestDate="+unformat($("#requestDate").val())
				+"&requestSeq="+$("#requestSeq").val();
		
		newWindow(url, "KEY01004D",600,350,"yes");
	}
	
	function Request() {
		
		if($("#myAppr").val() == "") {
			alert("<fmt:message key="KEY01004B.msg17"/>");
			return;
		}
		...
		if($("#requestTpCD").val() == "CHG") {
			...
			if($("#requestStateCD").val() != "10" && $("#requestStateCD").val() != "30" && $("#requestStateCD").val() != "50") {
				alert("<fmt:message key="KEY01004B.msg1"/>");
				return;
			}
		}
		
		if($("#venueCD").val()=="") {
			alert("<fmt:message key="KEY01004B.msg18"/>");
			$("#venueCD").focus();
			return;
		}
		if($("#keymanNm").val()=="") {
			alert("<fmt:message key="KEY01004B.msg2"/>");
			$("#keymanNm").focus();
			return;
		}
		if($("#keymanTypeCD").val()=="") {
			alert("<fmt:message key="KEY01004B.msg3"/>");
			$("#keymanTypeCD").focus();
			return;
		}
// 		if($("#regIDNo").val()=="") {
// 			alert("<fmt:message key="KEY01004B.msg4"/>");
// 			$("#regIDNo").focus();
// 			return;
// 		}
		if($("#keymanTypeCD").val() == "10") {
			if($("#birthDate").val()==""){
				alert("<fmt:message key="KEY01004B.msg25"/>");
				$("#birthDate").focus();
				return;
			}
// 			if(unformat($("#regIDNo").val()).length !="13") {
// 				alert("<fmt:message key="KEY01004B.msg16"/>");
// 				$("#regIDNo").focus();
// 				return;
// 			}
		} 
...
// 		}
		if($("#dutyCD").val()=="") {
			alert("<fmt:message key="KEY01004B.msg23"/>");
			$("#dutyCD").focus();
			return;
		}
		
		if($("#PkeymanYN").val()=="") {
			alert("<fmt:message key="KEY01004B.msg11"/>");
			$("#PkeymanYN").focus();
			return;
		}
		if($("#addr").val()=="") {
			alert("<fmt:message key="KEY01004B.msg6"/>");
			$("#addr").focus();
			return;
		}
		if($("#phoneNo").val()=="") {
			alert("<fmt:message key="KEY01004B.msg19"/>");
			$("#phoneNo").focus();
			return;
		}
// 		if("010"!=$("#phoneNo").val().substring(0,3)){
// 			alert("<fmt:message key="KEY01004B.msg20"/>");
// 			$("#phoneNo").focus();
// 			return;
// 		}
		...
		if($("#emailAddr").val()!="") {
			if(!filter.test($("#emailAddr").val())){
				alert("<fmt:message key="KEY01004B.msg22"/>");
				$("#emailAddr").focus();
				return;
			}
		}
// 		if($("#emailAddr").val()=="") {
// 			alert("<fmt:message key="KEY01004B.msg21"/>");
// 			$("#emailAddr").focus();
// 			return;
// 		}
// 		var filter = /^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;
...
// 		}
// 		if($("#bankCD").val()=="") {
// 			alert("<fmt:message key="KEY01004B.msg8"/>");
// 			$("#bankCD").focus();
// 			return;
// 		}
// 		if($("#accountNo").val()=="") {
// 			alert("<fmt:message key="KEY01004B.msg9"/>");
// 			$("#accountNo").focus();
// 			return;
// 		}
// 		if($("#holderNm").val()=="") {
// 			alert("<fmt:message key="KEY01004B.msg10"/>");
// 			$("#holderNm").focus();
// 			return;
// 		}
...
// 		}
		...
		if($("#keymanTypeCD").val() == "10") {
			...
			if(Number($("#ageGap").val()) >= 70) {
				alert("[주의] 만 70세 이상의 고령자 입니다.\n- 고령자 Customer는 업주인 경우에만 Customer로 등록이 가능합니다.\n- 업주임을 증명하기 위한 사업자등록증 사본을 발렉스에 제출 하여야 합니다.\n- 비고란에 Customer의 재직여부를 확인할 수 있는 내용을 작성하여야 합니다.\n- 업소 Customer가 아닌 가족, 친지, 배우자는 Customer 등록을 할 수 없습니다. (자사 자금세탁방지규정 참고)");
				if($("#requestTpCD").val() == "NEW" && $("#keymanTypeCD").val() == "10") { 
					if($("#note").val() == "") {
						alert("<fmt:message key="KEY01004B.msg12"/>");
						$("#note").focus();
						return;
					}
				}
...
// 		table.setParameter("licenceChkYn", $("#LicenceChkYn").val());
	...
	function Delete() {
		//승인요청, 반려, 인증오류인 경우에만 저장
		if($("#requestStateCD").val() != "10" && $("#requestStateCD").val() != "30" && $("#requestStateCD").val() != "50") {
			alert("<fmt:message key="KEY01004B.msg15"/>");
// 			alert("상태가 승인요청, 반려, 인증오류인 경우에만 삭제가능합니다.");
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/key01/deleteKeymanID_m");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("keymanID", $("#keymanID").val());
