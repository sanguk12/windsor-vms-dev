						        		...
						        		<tbody>
				                            <tr>
												<td class="td-cond-required">
													<fmt:message key="PLN02001A.eventYM" />
												</td>
												<td class="td-input">
											...
											<tr>
				                                ...
				                                <td class="td-cond">
													<fmt:message key="PLN02001A.subSegmentCD" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="PLN02001A.rageSphereCD" />
												</td>
												<td class="td-input">
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0200101S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/PLN0200106S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PLN0200105S");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
	  	table.setParameter("empID", "${params.empID}");
	  	table.setParameter("programCD", $("#programCD_S").val());
	  	table.setParameter("activityCD", $("#activityCD_S").val());
		...
		var headerText = [
			...
			, "<fmt:message key="PLN02001A.rageSphereCD"/>"
			, "<fmt:message key="PLN02001A.officeCD"/>"
			, "<fmt:message key="PLN02001A.empNm"/>"
			, "<fmt:message key="PLN02001A.venueCD"/>"
			, "<fmt:message key="PLN02001A.venueNm"/>"
			, "<fmt:message key="PLN02001A.venueGradCD"/>"
			, "<fmt:message key="PLN02001A.segmentCD"/>"
			, "<fmt:message key="PLN02001A.subSegmentCD"/>"
			, "<fmt:message key="PLN02001A.addrTpCD1"/>"
			, "<fmt:message key="PLN02001A.addrTpCD2"/>"
			, "<fmt:message key="PLN02001A.tpayAmt"/>"
			, "<fmt:message key="PLN02001A.planTQty"/>"
			, "<fmt:message key="PLN02001A.avgUnitAmt"/>"
			, "<fmt:message key="PLN02001A.gsvRate"/>"
			, "<fmt:message key="PLN02001A.threeMonthAvgRate"/>"
			, "<fmt:message key="PLN02001A.commt"/>"
			, "<fmt:message key="PLN02001A.apprCommt"/>"
			, "<fmt:message key="PLN02001A.apprStateCD_emp"/>"
			, "<fmt:message key="PLN02001A.apprStateCD"/>"
			, "<fmt:message key="PLN02001A.kindTpCD5"/>"
			, "<fmt:message key="PLN02001A.prdNm"/>"
			, "<fmt:message key="PLN02001A.factoryPrice"/>"
			, "<fmt:message key="PLN02001A.qtyUnitCD"/>"
			, "<fmt:message key="PLN02001A.threeMonthAvgQty"/>"
			, "<fmt:message key="PLN02001A.planQty"/>"
			, "<fmt:message key="PLN02001A.planUnitAmt"/>"
			, "<fmt:message key="PLN02001A.payAmt"/>"
		];
		
		table.setParameter("templateFile", "PLN02001A");
