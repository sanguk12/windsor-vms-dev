						        		...
						        		<tbody>
				                            <tr>
												<td class="td-cond-required">
													<fmt:message key="PLN03001A.eventYM" />
												</td>
												<td class="td-input">
				                                ...
				                                <td class="td-cond">
													<fmt:message key="PLN03001A.apprType" />
												</td>
												<td class="td-input">
				                                ...
				                                <td class="td-cond">
													<fmt:message key="PLN03001A.programCD" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
				                                ...
				                                <td class="td-cond">
													<fmt:message key="PLN03001A.officeCD" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="PLN03001A.dkmdTpCD" />
												</td>
												<td class="td-input">
...
<style type="text/css">
	...
	.aw-column-0 {width: 0px; text-align:center;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0300401S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			...
	  			"nsv;gp;gpRate;"+
	  			"apprStateCDName_emp;apprStateCDName;apprStateCD;"+
	  			"planChg;lapprLevelNo;levelNo;lastApprYN;rowNum;");
		...
		if(		   '${params.grpID}' == '000004' || '${params.grpID}' == '000003' || '${params.grpID}' == '000002' 
      	...
      	if (rowCount > 0) {
      		...
      		for (var i=0; i<rowCount; i++) {
      			...
      			var apprStateCDName = "<a href=\"javascript:openApprState('"+table.getData(_col.venueCD,i)+"');\">"+table.getData(_col.apprStateCDName,i)+"</a>";
			...
			table.setURL("${contextPath}/service/simpleAction/PLN0300402S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PLN0300405S");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
	  	table.setParameter("empID", "${params.userID}");
	  	table.setParameter("apprType", $("#apprType_S").val());
	  	table.setParameter("programCD", $("#programCD_S").val());
		...
		var headerText = [
			...
			, "<fmt:message key="PLN03001A.rageSphereCD"/>"
			, "<fmt:message key="PLN03001A.officeCD"/>"
			, "<fmt:message key="PLN03001A.empNm"/>"
			, "<fmt:message key="PLN03001A.venueCD"/>"
			, "<fmt:message key="PLN03001A.venueNm"/>"
			, "<fmt:message key="PLN03001A.venueGradCD"/>"
			, "<fmt:message key="PLN03001A.segmentCD"/>"
			, "<fmt:message key="PLN03001A.subSegmentCD"/>"
			, "<fmt:message key="PLN03001A.addrTpCD1"/>"
			, "<fmt:message key="PLN03001A.addrTpCD2"/>"
			, "<fmt:message key="PLN03001A.tpayAmt"/>"
			, "<fmt:message key="PLN03001A.planTQty"/>"
			, "<fmt:message key="PLN03001A.avgUnitAmt"/>"
			, "<fmt:message key="PLN03001A.gsvRate"/>"
			, "<fmt:message key="PLN03001A.threeMonthAvgRate"/>"			
			, "<fmt:message key="PLN03001A.planChg"/>"
			, "<fmt:message key="PLN03001A.apprStateCD_emp"/>"
			, "<fmt:message key="PLN03001A.kindTpCD5"/>"
			, "<fmt:message key="PLN03001A.prdNm"/>"
			, "<fmt:message key="PLN03001A.factoryPrice"/>"
			, "<fmt:message key="PLN03001A.qtyUnitCD"/>"
			, "<fmt:message key="PLN03001A.threeMonthAvgQty"/>"
			, "<fmt:message key="PLN03001A.planQty"/>"
			, "<fmt:message key="PLN03001A.planUnitAmt"/>"
			, "<fmt:message key="PLN03001A.payAmt"/>"
       		, "<fmt:message key="PLN01008A.NSV"/>"
    		, "<fmt:message key="PLN01008A.GP"/>"
    		, "<fmt:message key="PLN01008A.GPRate"/>"
		];
		
		table.setParameter("templateFile", "PLN03004A");
	...
	*****************************************************/
	var columns = [
		...
		, "<fmt:message key="PLN01008A.GPRate"/>"
		, "<fmt:message key="PLN03001A.planChg"/>"
		, "<fmt:message key="PLN03001A.apprStateCD"/>"
	];
