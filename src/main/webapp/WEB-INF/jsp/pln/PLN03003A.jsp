						        		...
						        		<tbody>
				                            <tr>
												<td class="td-cond-required">
													<fmt:message key="PLN02003A.eventYM" />
												</td>
												<td class="td-input">
				                                 ...
				                                 <td class="td-cond">
													<fmt:message key="PLN02003A.activityCD" />
												</td>
				                            ...
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="PLN02003A.rageSphereCD" />
												</td>
												<td class="td-input">
				                                ...
				                                <td class="td-cond">
													<fmt:message key="PLN02003A.officeCD" />
												</td>
												<td class="td-input">
...
<style type="text/css">
    ...
    .aw-column-5 {width: 140px; text-align:right;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0300301S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
            ...
            grid.setRowCount(rowCount-1);
      		...
      		grid.setFooterText(table.getData(_col.incntTpCDName,rowCount-1), _col.incntTpCDName);
      		grid.setFooterText(table.getData(_col.venueCount,rowCount-1), _col.venueCount);
      		grid.setFooterText(table.getData(_col.tpayAmt,rowCount-1), _col.tpayAmt);
      		grid.setFooterText(table.getData(_col.planTQty,rowCount-1), _col.planTQty);
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PLN0300301S");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
	  	table.setParameter("empID", "${params.userID}");
	  	table.setParameter("activityCD", $("#activityCD_S").val());
	  	table.setParameter("rageSphereCD", $("#rageSphereCD_S").val());
		...
		var headerText = [
			  "<fmt:message key="PLN02003A.incntTpCD"/>"
			, "<fmt:message key="PLN02003A.rageSphereCD"/>"
			, "<fmt:message key="PLN02003A.officeCD"/>"
			, "<fmt:message key="PLN02003A.empNm"/>"
			, "<fmt:message key="PLN02003A.venueCount"/>"
			, "<fmt:message key="PLN02003A.tpayAmt"/>"
			, "<fmt:message key="PLN02003A.planTQty"/>"
		];
		
		table.setParameter("templateFile", "PLN03003A");
