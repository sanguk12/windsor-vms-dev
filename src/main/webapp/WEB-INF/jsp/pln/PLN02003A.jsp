...
<script type="text/javascript">
	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0200301S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			"incntTpCDName;rageSphereCDName;officeCDName;empNm;venueCount;"+
	  			"tpayAmt;planTQty;countReq;countNoAppr;countAppr;"+
	  			"countClear;");
...
// 	  	if (grid != null) grid.clear();
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PLN0200301S");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
	  	table.setParameter("empID", "${params.empID}");
	  	table.setParameter("activityCD", $("#activityCD_S").val());
	  	table.setParameter("rageSphereCD", $("#rageSphereCD_S").val());
		...
		var headerText = [
			...
			, "<fmt:message key="PLN02003A.countReq"/>"
			, "<fmt:message key="PLN02003A.countNoAppr"/>"
			, "<fmt:message key="PLN02003A.countAppr"/>"
			, "<fmt:message key="PLN02003A.countClear"/>"
		];
		
		table.setParameter("templateFile", "PLN02003A");
