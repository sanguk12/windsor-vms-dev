	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0100302S");
...
// 	  	if (grid != null) grid.clear();
	...
	*****************************************************/
	var columns = [
		"<fmt:message key="PLN01003B.kindTpCD5"/>"
		, "<fmt:message key="PLN01003B.prdNm"/>"
		, "<fmt:message key="PLN01003B.factoryPrice"/>"
		, "<fmt:message key="PLN01003B.qtyUnitCDName"/>"
		, "<fmt:message key="PLN01003B.threeMonthAvgQty"/>"
		, "<fmt:message key="PLN01003B.planQty"/>"
		, "<fmt:message key="PLN01003B.planUnitAmt"/>"
		, "<fmt:message key="PLN01003B.payAmt"/>"
	];
