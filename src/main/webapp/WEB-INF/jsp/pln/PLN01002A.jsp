									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
										...
										<tbody>
											...
											<tr>
												...
												<td class="td-cond">
													<fmt:message key="PLN01002A.addrTpCD1" />
												</td>
												<td class="td-input">
											...
											<tr>
												...
												<td class="td-cond">
													<fmt:message key="PLN01002A.venue" />
												</td>
                		...
                		<table border="0" cellspacing="0" cellpadding="0" width="100%" >
			        		...
			        		<tbody>
			        			<tr>
	                                ...
	                                <td class="tit_text01" >
										<fmt:message key="PLN01002A.msg6" />
	                                </td>
	                            </tr>
			        		</tbody>
		        		</table>
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
							        				...
							        				<tbody>
			                            				...
			                            				<tr>
															...
															<td id="threeMonthAvgRate_td" class="td-report-rborder" style="text-align:right;" colspan="2">
			                            				...
			                            				<tr>
															<td class="td-cond-report" style="text-align:left;">
																<fmt:message key="PLN01002A.LofficeNGSV" />
															</td>
															<td class="td-report-rborder">
																&nbsp;<span id="LofficeNGSV"></span>
															</td>
															<td class="td-cond-report" style="text-align:left;">
																<fmt:message key="PLN01002A.LvenueNGSV" />
															</td>
															<td id="gsvRate_td" class="td-report-rborder" >
																&nbsp;<span id="LvenueNGSV"></span>
															</td>
															<td class="td-cond-report" style="text-align:left;">
																&nbsp;<span id="LocalRmnamtTitle"></span>
															</td>
															<td class="td-cond-report" style="text-align:left;">
																&nbsp;<span id="InterRmnamtTitle"></span>
															</td>
			                            				</tr>
			                            				<tr>
															<td class="td-cond-report" style="text-align:left;">
																<fmt:message key="PLN01002A.IofficeNGSV" />
															</td>
															<td class="td-report-rborder">
																&nbsp;<span id="IofficeNGSV"></span>
															</td>
															<td class="td-cond-report" style="text-align:left;">
																<fmt:message key="PLN01002A.IvenueNGSV" />
															</td>
															<td id="gsvRate_td" class="td-report-rborder" >
																&nbsp;<span id="IvenueNGSV"></span>
															</td>
															<td id="gsvRate_td" class="td-report-rborder" >
																&nbsp;<span id="LocalRmnamtView"></span>
															</td>
															<td id="gsvRate_td" class="td-report-rborder" >
																&nbsp;<span id="InterRmnamtView"></span>
															</td>
			                            				</tr>
...
<script language="javascript">
	...
	function calculateNGsvRate() {
		...
		for(var i=0; i<grid_prd.getRowCount(); i++) {
			...
			unitamt = parseFloat(unformat(grid_prd.getCellText(_col_prd.planUnitAmt, i)));
			planQty = parseFloat(unformat(grid_prd.getCellText(_col_prd.planQty, i)));
		
			if(kindtpcd == '10'){
				lTotalGsv += planQty * unitamt;
				lNgsv += planQty * gsv;
			}else{
				iTotalGsv += planQty * unitamt;
				iNgsv += planQty * gsv;
			}
		}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function Search_pln() {
		...
		getPlanWriteDate();
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0100201S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			"checkbox;programCDName;activityCDName;venueCD;venueNm;"+
	  			"venueGradCDName;addrTpCD2Name;tpayAmt;chgID;officeCD;");
...
// 	  	if (grid_pln != null) grid_pln.clear();
      	...
      	if (rowCount > 0) {
      		$("#officeCD").val(table.getData(_col_pln.officeCD, 0));
      		var data = new Array();
      		for (var i=0; i<rowCount; i++) {
      			data[i] = [
					...
					, table.getData(_col_pln.chgID,i)
					, table.getData(_col_pln.officeCD,i)
      			];
	...
	function Search_dtl() {
		var table = new AW.XML.Table;
	  	...
	  	table.setParameter("outParamKey",
	  			...
	  			"apprStateCDName;apprStateCD;commt;programCD;activityCD;"+
	  			"LofficeNGSV;IofficeNGSV;endYM;LocalRmnamt;InterRmnamt;");
	  	table.setParameter("format",
	  			"str;str;str;str;num;"+
	  			"num;num;num;num;str;"+
	  			"str;str;str;str;str;"+
      	...
      	if (rowCount > 0) {
    		...
    		table_t.setRequestMethod("POST");
         	...
         	if(table_t.getCount() > 0) {
      		...
      		$("#selectActivityCD").val(table.getData(_col_dtl.activityCD, 0));
      		$("#LofficeNGSV").text(table.getData(_col_dtl.LofficeNGSV, 0)+" %");
      		$("#IofficeNGSV").text(table.getData(_col_dtl.IofficeNGSV, 0)+" %");
      		$("#LocalRmnamt").val(table.getData(_col_dtl.LocalRmnamt, 0));
      		$("#InterRmnamt").val(table.getData(_col_dtl.InterRmnamt, 0));
      		if(table.getData(_col_dtl.activityCD, 0)=="20"){
      			$("#LocalRmnamtView").text(table.getData(_col_dtl.LocalRmnamt, 0));
	      		$("#InterRmnamtView").text(table.getData(_col_dtl.InterRmnamt, 0));
	      		$("#LocalRmnamtTitle").text("L.W. 미달성금액");
	      		$("#InterRmnamtTitle").text("I.W. 미달성금액");
      		}else{
      			$("#LocalRmnamtView").text("");
	      		$("#InterRmnamtView").text("");
	      		$("#LocalRmnamtTitle").text("");
	      		$("#InterRmnamtTitle").text("");
	...
	function Search_prd() {
		var table = new AW.XML.Table;
	  	...
	  	table.setParameter("outParamKey",
	  			...
	  			"planQty;planUnitAmt;payAmt;prdCD;gsv;"+
	  			"kindtpcd;");
	  	table.setParameter("format",
	  			"str;str;num;str;num;"+
	  			"num;num;num;str;str;"+
...
// 	  	if (grid_prd != null) grid_prd.clear();
      	...
      	if (rowCount > 0) {
      		...
      		if($("#selectActivityCD").val()=="50"){
      			grid_prd.setCellEditable(false, _col_prd.planQty);
      			grid_prd.setCellEditable(false, _col_prd.planUnitAmt);
      			grid_prd.getCellTemplate(_col_prd.planQty).setStyle("background", "#ececec");
				grid_prd.getCellTemplate(_col_prd.planUnitAmt).setStyle("background", "#ececec");
      		}
      	}
      	grid_prd.refresh();
	}
