...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0300101S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
		...
		if(		   '${params.grpID}' == '000004' || '${params.grpID}' == '000003' || '${params.grpID}' == '000002' 
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/PLN0300102S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PLN0300105S");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
	  	table.setParameter("empID", "${params.userID}");
	  	table.setParameter("programCD", $("#programCD_S").val());
	  	table.setParameter("activityCD", $("#activityCD_S").val());
		...
		table.setParameter("templateFile", "PLN03001A");
