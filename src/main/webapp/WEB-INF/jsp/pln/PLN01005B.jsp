	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0100505S");
	  	...
	  	table.setParameter("prdCD", "${params.prdCD}");
	  	table.request();
...
// 	  	if (grid != null) grid.clear();
	...
	*****************************************************/
	var columns = [
   		"<fmt:message key="PLN01005B.apprGrpNm"/>"
   		, "<fmt:message key="PLN01005B.empID"/>"
   		, "<fmt:message key="PLN01005B.empNm"/>"
   		, "<fmt:message key="PLN01005B.apprStateCD"/>"
   		, "<fmt:message key="PLN01005B.apprDate"/>"
   		, "<fmt:message key="PLN01005B.commt"/>"
	];
