	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0100206S");
...
// 	  	if (grid != null) grid.clear();
	...
	*****************************************************/
	var columns = [
		"<fmt:message key="PLN01002B.apprGrpNm"/>"
		, "<fmt:message key="PLN01002B.empID"/>"
		, "<fmt:message key="PLN01002B.empNm"/>"
		, "<fmt:message key="PLN01002B.apprStateCD"/>"
		, "<fmt:message key="PLN01002B.apprDate"/>"
		, "<fmt:message key="PLN01002B.commt"/>"
	];
