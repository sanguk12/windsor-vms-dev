						        		...
						        		<tbody>
				                            <tr>
												<td class="td-cond-required">
													<fmt:message key="PLN03002A.eventYM" />
												</td>
												<td class="td-input">
											...
											<tr>
												<td class="td-cond">
													<fmt:message key="PLN03002A.segmentCD" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="PLN03002A.rageSphereCD" />
												</td>
												<td class="td-input">
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch(){
		...
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PLN0300201S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			...
	  			"gsvRate;apprStateCDName_emp;apprStateCDName;"+
		...
		// ---
      	...
      	if (rowCount > 0) {
      		...
      		for (var i=0; i<rowCount; i++) {
      			...
      			var apprStateCDName = "<a href=\"javascript:openApprState('"+i+"');\">"+table.getData(_col.apprStateCDName,i)+"</a>";
			...
			table.setURL("${contextPath}/service/simpleAction/PLN0300202S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PLN0300201S");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
		...
		var headerText = [
       		...
       		, "<fmt:message key="PLN03002A.rageSphereCD"/>"
       		, "<fmt:message key="PLN03002A.officeCD"/>"
       		, "<fmt:message key="PLN03002A.empNm"/>"
       		, "<fmt:message key="PLN03002A.venueCD"/>"
       		, "<fmt:message key="PLN03002A.venueNm"/>"
       		, "<fmt:message key="PLN03002A.venueGradCD"/>"
       		, "<fmt:message key="PLN03002A.segmentCD"/>"
       		, "<fmt:message key="PLN03002A.subSegmentCD"/>"
       		, "<fmt:message key="PLN03002A.addrTpCD1"/>"
       		, "<fmt:message key="PLN03002A.addrTpCD2"/>"
       		, "<fmt:message key="PLN03002A.kindTpCD5"/>"
       		, "<fmt:message key="PLN03002A.prdNm"/>"
       		, "<fmt:message key="PLN03002A.factoryPrice"/>"
       		, "<fmt:message key="PLN03002A.qtyUnitCD"/>"
       		, "<fmt:message key="PLN03002A.planQty"/>"
       		, "<fmt:message key="PLN03002A.planUnitAmt"/>"
       		, "<fmt:message key="PLN03002A.guidAmt"/>"
       		, "<fmt:message key="PLN03002A.payAmt"/>"
       		, "<fmt:message key="PLN03002A.gsvRate"/>"       		
       		, "<fmt:message key="PLN03002A.planChg"/>"  
       		, "<fmt:message key="PLN03002A.apprStateCDName"/>"
		];
		
		table.setParameter("templateFile", "PLN03002A");
