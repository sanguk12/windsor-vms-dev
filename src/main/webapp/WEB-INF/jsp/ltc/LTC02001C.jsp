	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/LTC0200108S");
...
// 	  	if (grid != null) grid.clear();
	...
	*****************************************************/
	var columns = [
		"<fmt:message key="LTC02001C.apprGrpNm"/>"
		, "<fmt:message key="LTC02001C.empID"/>"
		, "<fmt:message key="LTC02001C.empNm"/>"
		, "<fmt:message key="LTC02001C.apprStateCD"/>"
		, "<fmt:message key="LTC02001C.apprDate"/>"
		, "<fmt:message key="LTC02001C.commt"/>"
	];
