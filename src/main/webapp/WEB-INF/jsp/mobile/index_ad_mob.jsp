...
<%@ include file="/WEB-INF/jsp/sys3/taglib.jsp"%>
...
<html lang="ko">
	...
	<body>
		<div class="wrapper">
			<div class="wrap">
				<div class="img"></div>
				<h1><img src="${contextPath}/images/login_ad/title.gif" alt="DIAGEO Customer Incentive Management System" /></h1>
				<div class="login">
					...
					<form id="form" name="form" method="post">
						<section>
							...
							<input type="hidden" id="dkmdTpCD" name="dkmdTpCD" value="MD" />
							<input type="hidden" id="displayMnuTp" name="displayMnuTp" value="200" /> 
				...
				<div>
				<div class="footer">
					<b>02) 596-4301</b> 서울특별시 서초구 서초대로 137
				</div>
				</div>
			</div>
		</div>
