...
<html lang="ko">
	...
	<body>
		<div class="wrapper">
			<div class="wrap">
				<div class="img"></div>
				<h1><img src="${contextPath}/images/login_ad/title_tl_mob.gif" alt="DIAGEO Customer Incentive Management System" /></h1>
				<div class="login">
					...
					<form id="form" name="form" method="post">
						<section>
							...
							<input type="hidden" id="dkmdTpCD" name="dkmdTpCD" value="TL" />
				...
				<div>
				<div class="footer">
					<b>02) 556-5201</b> 서울특별시 강남구 역삼동 635-6
				</div>
				</div>
			</div>
		</div>
