...
<html lang="ko">
	...
	<body>
		<div class="wrapper">
			<div class="wrap">
				<div class="img"></div>
				<h1><img src="${contextPath}/images/login_ad/title_dx_mob.gif" alt="DIAGEO Customer Incentive Management System" /></h1>
				<div class="login">
					...
					<form id="form" name="form" method="post">
						<section>
							...
							<input type="hidden" id="dkmdTpCD" name="dkmdTpCD" value="DX" />
				...
				<div>
				<div class="footer">
					<b>02) 6925-1134</b> 서울특별시 영등포구 문래동5가 4-1 
				</div>
				</div>
			</div>
		</div>
