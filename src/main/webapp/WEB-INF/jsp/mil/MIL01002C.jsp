									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
						        		...
						        		<tbody>
				                            <tr>
				                            	<td></td>
												<td class="td-cond">
													<fmt:message key="MIL01002C.msg1" />
												</td>
				                            ...
				                            <tr>
				                            	<td></td>
												<td class="td-cond">
													<fmt:message key="MIL01002C.msg2" />
												</td>
												<td class="td-input" style="text-align:right; padding-right:5px;">
	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/MIL0100204S");
...
// 	  	if (grid != null) grid.clear();
	...
	function Search_reg() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/MIL0100205S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			"checkbox;keymanID;keymanNm;birthDate;bankCDName;"+
...
// 	  	if (grid_reg != null) grid_reg.clear();
	...
	function Add() {
		if(opener.$("#resultWriteYN").val() == "N") {
			alert("<fmt:message key="MIL01002C.msg3" />");
			return;
		}
		...
		var mileageStateCD = "${params.mileageStateCD}";
		var verifyStateCD = "${params.verifyStateCD}";
		if(mileageStateCD != "" && mileageStateCD!="10" && mileageStateCD!="40" && mileageStateCD!="50") {
			alert("<fmt:message key="MIL01002C.msg4" />");
			return;
		}
	...
	*****************************************************/
	var columns = [
		""
		, "<fmt:message key="MIL01002C.keymanID"/>"
		, "<fmt:message key="MIL01002C.keymanNm"/>"
		, "<fmt:message key="MIL01002C.birthDate"/>"
		, "<fmt:message key="MIL01002C.bankCDName"/>"
		, "<fmt:message key="MIL01002C.accountNo"/>"
		, "<fmt:message key="MIL01002C.pkeymanYN"/>"
	];
	...
	var columns_reg = [
		...
		, "<fmt:message key="MIL01002C.bankCDName"/>"
		, "<fmt:message key="MIL01002C.accountNo"/>"
		, "<fmt:message key="MIL01002C.payAmt"/>"
	];
	var grid_reg = null;
