						        		...
						        		<tbody>
				                            <tr>
												<td class="td-cond-required">
													<fmt:message key="MIL03002A.contractDate" />
												</td>
												<td class="td-input">
				                                ...
				                                <td class="td-cond">
				                                	<fmt:message key="MIL03002A.contractOverYN" />
												</td>
												<td class="td-input" colspan="3">
													<select id="contractOverYN">
														<option value=""><fmt:message key="all" /></option>
														<option value="Y"><fmt:message key="MIL03002A.progressIng" /></option>
														<option value="N"><fmt:message key="MIL03002A.progressComplete" /></option>
													</select>
												</td>
				                            </tr>
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="MIL03002A.rageSphereCD" />
												</td>
												<td class="td-input">
...
<script type="text/javascript">
	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/MIL0300201S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
...
// 	  	if (grid != null) grid.clear();
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "MIL0300201S");
		table.setParameter("contractDateFrom", unformat($("#contractDateFrom_S").val()));
	  	table.setParameter("contractDateTo", unformat($("#contractDateTo_S").val()));
	  	table.setParameter("contractOverYN", $("#contractOverYN").val());
	  	table.setParameter("rageSphereCD", "${params.rageSphereCD}");
		...
		var headerText = [
			"<fmt:message key="MIL03002A.MileageID"/>"
			, "<fmt:message key="MIL03002A.venueCD"/>"
			, "<fmt:message key="MIL03002A.venueNm"/>"
			, "<fmt:message key="MIL03002A.contractDate"/>"
			, "<fmt:message key="MIL03002A.contractMonthCt"/>"
			, "<fmt:message key="MIL03002A.apAmt"/>"
			, "<fmt:message key="MIL03002A.addAmt"/>"
			, "<fmt:message key="MIL03002A.msTargetRate"/>"
			, "<fmt:message key="MIL03002A.kindTpCD5"/>"
			, "<fmt:message key="MIL03002A.prdNm"/>"
			, "<fmt:message key="MIL03002A.contractQty"/>"
			, "<fmt:message key="MIL03002A.enterQty"/>"
			, "<fmt:message key="MIL03002A.qtyUnitCD"/>"
			, "<fmt:message key="MIL03002A.enterUnitAmt"/>"
			, "<fmt:message key="MIL03002A.payAmt"/>"
			, "<fmt:message key="MIL03002A.resultQty"/>"
			, "<fmt:message key="MIL03002A.payAmt_rlt"/>"
			, "<fmt:message key="MIL03002A.rate"/>"
		];
		
		table.setParameter("templateFile", "MIL03002A");
	...
	*****************************************************/
	var columns = [
		...
		, "<fmt:message key="MIL03002A.qtyUnitCD"/>"
		, "<fmt:message key="MIL03002A.enterUnitAmt"/>"
		, "<fmt:message key="MIL03002A.stipulationAmt"/>"
		, "<fmt:message key="MIL03002A.resultQty"/>"
		, "<fmt:message key="MIL03002A.payAmt_rlt"/>"
		, "<fmt:message key="MIL03002A.rate"/>"
	];
