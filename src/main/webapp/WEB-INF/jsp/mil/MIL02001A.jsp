								        		...
								        		<tbody>
						                            <tr>
														<td class="td-cond-required">
															<fmt:message key="MIL02001A.payRequestDate" />
														</td>
														<td class="td-input">
						                                ...
						                                <td class="td-cond">
															<fmt:message key="MIL02001A.mileagStateCD_emp" />
														</td>
						                            ...
						                            <tr>
						                            	<td class="td-cond">
															<fmt:message key="MIL02001A.rageSphereCD" />
														</td>
														<td class="td-input">
...
<script language="javascript">
	...
	function openVerifyState(mileageID) {
		var url = "${contextPath}/service/simpleCommand/?mnuGrpID=${params.mnuGrpID}&pgmID=${params.pgmID}&viewID=MIL02001C"
				+"&mileageID="+mileageID
				+"&apprTpID="+$("#apprTpID").val()
		
		newWindow(url, "MIL02001C",600,350,"yes");
	}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/MIL0200101S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
...
// 	  	if (grid != null) grid.clear();
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "MIL0200101S");
		table.setParameter("payRequestDateFrom", unformat($("#payRequestDateFrom_S").val()));
	  	table.setParameter("payRequestDateTo", unformat($("#payRequestDateTo_S").val()));
	  	table.setParameter("mileageStateCD", $("#mileageStateCD_S").val());
	  	table.setParameter("mileagePayTPCD", $("#mileagePayTPCD").val());
		...
		var headerText = [
			"<fmt:message key="MIL02001A.mileageID"/>"
			, "<fmt:message key="MIL02001A.rageSphereCD"/>"
			, "<fmt:message key="MIL02001A.officeCD"/>"
			, "<fmt:message key="MIL02001A.empNm"/>"
			, "<fmt:message key="MIL02001A.venueCD"/>"
			, "<fmt:message key="MIL02001A.venueNm"/>"
			, "<fmt:message key="MIL02001A.venueGradCD"/>"
			, "<fmt:message key="MIL02001A.segmentCD"/>"
			, "<fmt:message key="MIL02001A.subSegmentCD"/>"
			, "<fmt:message key="MIL02001A.addrTpCD1"/>"
			, "<fmt:message key="MIL02001A.addrTpCD2"/>"
			, "<fmt:message key="MIL02001A.contractDateFrom"/>"
			, "<fmt:message key="MIL02001A.contractDateTo"/>"
			, "<fmt:message key="MIL02001A.contractMonthCt"/>"
			, "<fmt:message key="MIL02001A.msTargetRate"/>"
			, "<fmt:message key="MIL02001A.tcontractQty"/>"
			, "<fmt:message key="MIL02001A.gsvAmt"/>"
			, "<fmt:message key="MIL02001A.gsvRate"/>"
			, "<fmt:message key="MIL02001A.contractAmt"/>"
			, "<fmt:message key="MIL02001A.contractTaxAmt"/>"
			, "<fmt:message key="MIL02001A.addContractAmt"/>"
			, "<fmt:message key="MIL02001A.addContractTaxAmt"/>"
			, "<fmt:message key="MIL02001A.payRequestDate"/>"
			, "<fmt:message key="MIL02001A.mileageStateCD"/>"
			, "<fmt:message key="MIL02001A.mileagePayTPCD"/>"
			, "<fmt:message key="MIL02001A.commt"/>"
			, "<fmt:message key="MIL02001A.apprCommt"/>"
		];
		
		table.setParameter("templateFile", "MIL02001A");
