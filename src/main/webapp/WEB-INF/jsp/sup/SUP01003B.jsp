...
<script language="javascript">
		...
		var table = new AW.XML.Table;
      	...
      	if (rowCount > 0) {
      		...
      		if(table.getData(0,0)>=3){
      			alert("<fmt:message key="SUP01001B.msg10" />");
      			$("#contractDateTo").val("");
    			$("#contractMonthCt").val("0");
    			$("#contractDateTo").focus();
      		}
	...
	keyman_btn.onControlClicked = function(event) {
		if($("#selectSupportID").val() != "") {
			...
			var url = "${contextPath}/service/simpleCommand/?mnuGrpID=${params.mnuGrpID}&pgmID=${params.pgmID}&viewID=SUP01003C&contractAmt="+contractAmt+"&venueCD="+venueCD+"&supportID="+supportID;
			newWindow(url, "SUP01003C",700,550,"yes");
		}
	}
