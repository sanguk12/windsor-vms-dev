...
// 		}
		...
		var url = "${contextPath}/service/simpleCommand/?mnuGrpID=${params.mnuGrpID}&pgmID=${params.pgmID}&viewID=SUP01002C&mainAddAmt="+mainAddAmt+"&venueCD="+venueCD+"&supportID="+supportID;
		newWindow(url, "SUP01002C",700,570,"yes");
	}
