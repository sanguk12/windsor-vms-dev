					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
		            	<tr>
		                    <td height="1">
								...
								<input type="hidden" id="appSrc" name="appSrc" value="${contextPath}/service/simpleCommand/?mnuGrpID=${params.mnuGrpID}&pgmID=${params.pgmID}&viewID=SUP02002B" />
							</td>
						</tr>
						<tr>
							<td height="1">
											...
											<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
								        		...
								        		<tbody>
					                                ...
					                                <tr>
						                                ...
						                                <td class="td-cond">
															<fmt:message key="SUP02002A.venue" />
														</td>
														<td class="td-input">
...
<style type="text/css">
    ...
    .aw-column-28 {width: 120px; text-align:left;}
