		            ...
		            <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
		            	<tr>
		                    <td height="1">
								...
								<input type="hidden" id="appSrc_upload" name="appSrc_upload" value="${contextPath}/service/simpleCommand/?mnuGrpID=${params.mnuGrpID}&pgmID=${params.pgmID}&viewID=MDM06001C" />
							</td>
						</tr>
		                <tr>
		                	<td height="1">
...
<script type="text/javascript">
	...
	****************************************/
	...
	function Update() {
		...
		appletDiv_set({"src":$("#appSrc").val()+"&initAction=Update", "appPositionCD":"${params.appPositionCD}", "appDisRate":"${params.appDisRate}", "appDisUnitCD":"${params.appDisUnitCD}"});
		appletOpen();
	}
	...
	function PagingSearch() {
		...
		table.setURL("${contextPath}/service/simpleAction/MDM0600101S");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("outParamKey",
	  									"requestDate;requestStateCDName;venueCD;venueNm;territoryCDName;"+
	  									"phoneNo;fasciaCDName;venueGradCDName;addrTpCD1Name;addrTpCD2Name;"+
	  									"addrTpCD3Name;oldAddr2;postCD;siteCDName;channelCDName;"+
	  									"subChannelCDName;segmentCDName;subSegmentCDName;reserveSegmentCDName;ageingCDName;"+
	  									"kegYN;activeYN;requestCommt;ws1SapCD;ws1SapCDName;"+
	  									"branch1;ws2SapCD;ws2SapCDName;branch2;ws3SapCD;"+
	  									"ws3SapCDName;branch3;ws4SapCD;ws4SapCDName;branch4;"+
	  									"rowNum;"
	  						);
		...
		table.request();
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/MDM0600104S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function DownloadToInput() {
        form.action = "${contextPath}/service/mdm06/downloadFile";
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "MDM0600105S");
		table.setParameter("empID", "${params.empID}");
	  	table.setParameter("requestDateFrom", convertDate($("#requestDateFrom_S").val()));
		table.setParameter("requestDateTo", convertDate($("#requestDateTo_S").val()));
		table.setParameter("apprStateCD", $("#apprStateCD_S").val());
		...
		table.setParameter("templateFile", "MDM06001A");
