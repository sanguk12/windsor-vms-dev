			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" >
							...
							<tr>
								<td class="tb-border" height="1" valign="top">
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px;">
										...
										<tbody>
											<tr>
												<td class="td-cond"><fmt:message key="MDM05001A.venueCD"/>
												</td>
											...
											<tr>
												...
												<td class="td-input"  colspan="2">
													<nis:selectbox id="venueGradCD" name="venueGradCD" defaultText="select" category="LOCALGRADCD" style="width:130px;" />
												</td>
				...
				<tr>
					<td height="1">
						...
						<input type="hidden" id="activeYN" name="activeYN" />
...
<script type="text/javascript">
	...
	****************************************/
    ...
    function Search() {
    	...
    	table.setURL("${contextPath}/service/simpleAction/MDM0500102S");
    	table.setAsync(false);
    	table.setRequestMethod("POST");
    	table.setParameter("tmpVenueCD", parent.$("#selectVenueCD").val());
    	table.request();
		...
		if (rowCount > 0) {
			$("#activeFlg").val("U");
			$("#venueCD").val(table.getData(_col.tmpVenueCD,0));
	...
	function Save() {
		...
		var table = new AW.XML.Table;     
		table.setURL("${contextPath}/service/mdm05/saveTmpVenue");
		table.setAsync(false);
		table.setRequestMethod("POST");
