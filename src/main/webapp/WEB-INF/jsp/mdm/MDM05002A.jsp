...
<style type="text/css">
    ...
    #grid .aw-header-1 .aw-column-2 {text-align:left;}    
    ...
    #grid .aw-column-21 {width: 100px; text-align:cente;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		...
		table.setURL("${contextPath}/service/simpleAction/MDM0500201S");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("outParamKey",
				"checkbox;requestDate;requestStateCDName;mdDupYN;tmpVenueCD;"+                           
				...
				"reserveSegmentCDName;ageingCDName;kegYNName;mdVenueCD;locationCDName;"+                        
				"ws1SapCD;ws1SapCDName;branch1;ws2SapCD;ws2SapCDName;"+                           
				"branch2;ws3SapCD;ws3SapCDName;branch3;ws4SapCD;"+
				"ws4SapCDName;branch4;requestStateCD;venueCD;rowNum;"
				);                                                                                
		...
		table.request();
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/MDM0500202S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function RequestApp() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/mdm05/requestApprTmpVenue");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("empID", "${params.empID}");
		table.setParameter("apprTpID", $("#apprTpID").val());
	...
	function ClearRequestApp() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/mdm05/clearRequestApprTmpVenue");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("empID", "${params.empID}");
		table.setParameter("tmpVenueCDs", tmpVenueCDs);
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "MDM0500204S");
		table.setParameter("empID", "${params.empID}");
		table.setParameter("requestDateFrom", convertDate($("#requestDateFrom_S").val()));
		table.setParameter("requestDateTo", convertDate($("#requestDateTo_S").val()));
		table.setParameter("apprStateCD", $("#apprStateCD_S").val());
		...
		table.setParameter("templateFile", "MDM05002A");
