...
<% 
	...
	//String confmKey = "devU01TX0FVVEgyMDIxMDcwMTEwNTkyNDExMTM0NDk="; // 검색API 승인키(local) 2021-07-01 update
	String confmKey = "U01TX0FVVEgyMDIxMDcwMTExNDYwMDExMTM0NTM="; // 검색API 승인키(dev/real) 2021-07-01 update
...
%>
<script type="text/javascript" src="${contextPath}/scripts/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="${contextPath}/scripts/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="${contextPath}/images/juso/addrlink.css"></link>
