		  	...
		  	$(document).ready(function() {
				...
				window.onload = function() {
					...
					if(host == "kiaad.co.kr" || host == "www.kiaad.co.kr") {
						document.location.href = "index_ad.page";
					}
					else if(host == "kiatl.co.kr" || host == "www.kiatl.co.kr") {
						document.location.href = "index_tl.page";
					}
					else if(host == "kiamp.co.kr" || host == "www.kiamp.co.kr") {
						document.location.href = "index_mp.page";
					}
					else if(host == "kiadx.co.kr" || host == "www.kiadx.co.kr") {
						document.location.href = "index_dx.page";
					}
					else if(host == "vmsmp.co.kr" || host == "www.vmsmp.co.kr") {
						document.location.href = "index_mp.page";
					}
					else if(host == "vmsdx.co.kr" || host == "www.vmsdx.co.kr") {
						document.location.href = "index_mp.page";
					}
					else {
						document.location.href = "index_dk.page";
					}
				};	
			});
