...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch(){
		var table = new AW.XML.Table;	  
	  	table.setURL("${contextPath}/service/simpleAction/COM03002A01S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	/*
	  	table.setParameter("outParamKey",
	  	...
	  	*/
	  	table.setParameter("outParamKey",
	  			//"checkbox;programCDName;activityCDName;rageSphereCDName;officeCDName;"+
	  			"programCDName;activityCDName;rageSphereCDName;officeCDName;"+
       	...
       	if (rowCount > 0) {
       		...
       		for (var i=0; i < rowCount; i++) {
				...
				if(periodPayAmt == ""){
       			...
       			tpayAmtSum = tpayAmtSum + parseFloat(unformatNum(payAmts[i]));
