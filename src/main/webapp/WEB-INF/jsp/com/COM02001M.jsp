...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/COM02001M01S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	...
	  	table.setParameter("lApplyDateFrom","");
	  	table.setParameter("lApplyDateTo", "");
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/COM02001M02S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "COM02001M01S");
	  	table.setParameter("venueGradCD", $("#venueGradCD_S").val());
	  	table.setParameter("addrTpCD1", $("#addrTpCD1_S").val());
	  	table.setParameter("addrTpCD2", $("#addrTpCD2_S").val());
	  	table.setParameter("venueCD", $("#venueCD_S").val());
	...
	function Choice() {
		...
		var data = {
			"keymanID":grid.getCellText(_col.keymanID, grid.getCurrentRow())
			, "keymanNm":grid.getCellText(_col.keymanNm, grid.getCurrentRow())
		};
