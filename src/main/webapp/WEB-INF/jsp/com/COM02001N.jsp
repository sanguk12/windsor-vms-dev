                    			...
                    			<td class="tb-border">
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
										...
										<tbody>
				                            <tr>
					                  			<td class="td-cond">
<!-- 													<fmt:message key="COM02001N.categoryCD1" /> -->
													카테고리1
												</td>
					                           	<td class="td-input">
					                            ...
					                            <td class="td-cond">
<!-- 													<fmt:message key="COM02001N.categoryCD2" /> -->
													카테고리2
												</td>	
												<td class="td-input">
												...
												<td class="td-cond">
<!-- 													<fmt:message key="COM02001N.categoryCD3" /> -->
													카테고리3
												</td>	
												<td class="td-input">
				                           	...
				                           	<tr>
				                               	<td class="td-cond">
<!-- 													<fmt:message key="COM02001N.categoryCD4" /> -->
													카테고리4
												</td>
												<td class="td-input">
												...
												<td class="td-cond">
<!-- 													<fmt:message key="COM02001N.categoryCD5" /> -->
													카테고리5
												</td>
												<td class="td-input">
				                                ...
				                                <td class="td-cond">
<!-- 					                           		<fmt:message key="COM02001N.activeYN" /> -->
													관리여부
				      							</td>
				      							<td class="td-input">
				   							...
				   							<tr>    
				                               	<td class="td-cond">
<!-- 													<fmt:message key="COM02001N.prdNm" /> -->
													제품명
												</td>
...
<script type="text/javascript">
	...
	****************************************/
            ...
            if (grid.getCellValue(_col.checkbox, index[i])) {   // CheckBox : true 일때
            	...
            	var data = {
            		"kindTpCD5Name":grid.getCellText(_col.kindTpCD5Name, index[i])
           			...
           			, "gsv":grid.getCellText(_col.gsv, index[i])
					, "duty":grid.getCellText(_col.duty, index[i])
					, "wsdc":grid.getCellText(_col.wsdc, index[i])
					, "cogs":grid.getCellText(_col.cogs, index[i])
					, "threeMonthAvgQty":grid.getCellText(_col.threeMonthAvgQty, index[i])
           		};
	...
	function PagingSearch(){
		var table = new AW.XML.Table;	  
	  	table.setURL("${contextPath}/service/simpleAction/COM02001N01S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			...
	  			"gsv;duty;wsdc;cogs;threeMonthAvgQty;"+
	  			"rowNum;totalCount;");
...
//       	if (grid != null) grid.clear();
	...
	*****************************************************/
	...
	var columns = [
//         "<fmt:message key="COM02001N.barCode"/>",
//         "<fmt:message key="COM02001N.prdCD"/>",
//         "<fmt:message key="COM02001N.prdNm"/>",
//         "<fmt:message key="COM02001N.prdLTpCD"/>",
//         "<fmt:message key="COM02001N.custPrice"/>",
//         "<fmt:message key="COM02001N.supPrice"/>"
	...
	function createGrid() {
		...
		grid.onRowDoubleClicked = function(event, row) {
			var data = {
				...
				, "gsv":grid.getCellText(_col.gsv, grid.getSelectedRows())
				, "duty":grid.getCellText(_col.duty, grid.getSelectedRows())
				, "wsdc":grid.getCellText(_col.wsdc, grid.getSelectedRows())
				, "cogs":grid.getCellText(_col.cogs, grid.getSelectedRows())
				, "threeMonthAvgQty":grid.getCellText(_col.threeMonthAvgQty, grid.getSelectedRows())
			};
           	<c:if test="${!empty params.finalAction}"> 
    			opener.${params.finalAction}(data);
    		</c:if>
