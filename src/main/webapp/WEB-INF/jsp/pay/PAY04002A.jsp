									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
						        		...
						        		<tbody>
											...
											<tr>
				                            	...
				                            	<td class="td-cond">
													<fmt:message key="PAY04001A.keyChkYN" />
												</td>
												<td class="td-input">
...
<style type="text/css">
    ...
    .aw-column-16 {width: 200px; text-align:left;}
    .aw-column-17 {width: 80px; text-align:center;}
    .aw-column-18 {width: 90px; text-align:center;}
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	...
	  	table.setParameter("outParamKey",
	  			...
	  			"payApprDate;payCommt;payStateCDName;keyChkYN;payStateCD;" + 
	  			"keyChkYNCD;rowNum;totalCount;");
...
// 	  	if (grid != null) grid.clear();
	...
	function openKeymanPopup(venueCD, payStateCD) {
		...
		newWindow(url, "PAY04001B",850,550,"yes");
	}
	...
	function Approval() {
		...
		if(keyChkCount>0){
			if(count==0){
				alert("<fmt:message key="PAY04002A.msg7"/>");
				return;
			}else{
				if(!confirm(errVenue.replace(/&amp;/g, '&')+"\n<fmt:message key="PAY04002A.msg6"/>")) {
       				return;
       			}
			}
		}else{
	...
	function Reject() {
		...
		if(keyChkCount>0){
			if(count==0){
				...
				if(!confirm(errVenue.replace(/&amp;/g, '&')+"\n<fmt:message key="PAY04002A.msg8"/>")) {
       				return;
       			}
			}
		}else{
