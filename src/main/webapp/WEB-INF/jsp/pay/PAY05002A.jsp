						        		...
						        		<tbody>
				                            ...
				                            <tr>
				                            	...
				                            	<td class="td-input">
					                           	...
					                           	<td class="td-cond">
													<fmt:message key="PAY05001A.keymanNm" />
												</td>
												<td class="td-input">
													<nis:popup id="keyman_S" nameID="keymanNm_S" keyID="keymanID_S" style="width:100px;" />
				                                </td>
				                            </tr>
			                            </tbody>
			                        </table>
...
<style type="text/css">
    ...
    .aw-column-30 {width: 100px; text-align:center;}
    ...
    .aw-column-34 {width: 150px; text-align:left; }
    .aw-column-35 {width: 100px; text-align:left;}
    .aw-column-36 {width: 100px; text-align:left;}
    .aw-column-37 {width: 90px; text-align:center;}
    .aw-column-38 {width: 80px; text-align:center;}
    .aw-column-39 {width: 120px; text-align:center;}
    .aw-column-40 {width: 100px; text-align:center; }
...
<script language="javascript">
	...
	$(document).ready(function() {
		...
		$("#keyman_S_popup").click(function(){
			openKeymanPopup("closeKeymanPopup");
		});
		$("#keyman_S").keypress(function(){
			if (event.keyCode==13){
				getKeymanName("keyman_S", "keymanID_S", "keymanNm_S");
				if($("#keymanID_S").val()!="") {
					Search();
				}
			}
	...
	function closeKeymanPopup(data){
		$("#keyman_S").val(data.keymanID);
		$("#keymanID_S").val(data.keymanID);
        $("#keymanNm_S").val(data.keymanNm);
	}
	var _col_cd = {
		"code" : 0
		, "name" : 1
	...
	function setMonthBefore() {
		...
		table.setParameter("outParamKey",
     	...
     	if(table.getCount() > 0) {
			...
			$("#yearCDTo_S").val(yearTemp);
			$("#monthCDTo_S").val(monthTemp);
		}
	}
</script>
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PAY0500201S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			...
	  			"targetQty;sdxTpCDName;targetRate;gsvRate;mileageYN;commt;"+
	  			"verifyStateCDName;payStateCDName;payCommt;transferDueDate;transferDate;keymanName;"+
	  			"bankCDName;accountNo;holderNm;sdxTpCD;activityCD;rowNum;");
	  	table.setParameter("format",
	  	...
	  	table.setParameter("keymanID", $("#keymanID_S").val());
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
      		...
      		for (var i=0; i<rowCount; i++) {
      			...
      			data[i] = [
					...
					, table.getData(_col.mileageYN,i)
      			...
      			if(resultUnitAmt > guidAmt && table.getData(_col.activityCD,i) != "99") {
			...
			table.setURL("${contextPath}/service/simpleAction/PAY0500202S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PAY0500201S");
		table.setParameter("rageSphereCD_S", "${params.rageSphereCD}");
	  	table.setParameter("officeCD_S", "${params.officeCD}");
	  	table.setParameter("teamCD_S", "${params.teamCD}");
	  	table.setParameter("territoryCD", "${params.territoryCD}");
		...
		var headerText = [
				...
				, "<fmt:message key="PAY05002A.mileageYN"/>"
		...
		table.setParameter("templateFile", "PAY05002A");
	...
	*****************************************************/
	...
	function createGrid() {
	    ...
	    grid.setCellFormat([
							...
							, str, num, num, num, num, num5, str, num, num, str, str 
