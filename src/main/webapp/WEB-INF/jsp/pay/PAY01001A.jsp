										...
										<tbody>
											<tr>
												<td class="td-cond-required">
													<fmt:message key="PAY01001A.eventYM" />
												</td>
												<td class="td-input">
											...
											<tr>
												<td class="td-cond">
													<fmt:message key="PAY01001A.addrTpCD1" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="PAY01001A.venue" />
												</td>
                	...
                	<td height="1">
                		<table border="0" cellspacing="0" cellpadding="0" width="100%" >
			        		...
			        		<tbody>
			        			<tr>
									<td class="tit_text01">
										<fmt:message key="PAY01001A.resultWriteDate" />
									</td>
									<td class="tit_text01">
							        				...
							        				<tbody>
						                            	<tr>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.programCD" />
															</td>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.activityCD" />
															</td>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.venueCD" />
															</td>
															<td class="td-cond-report" colspan="2">
																<fmt:message key="PAY01001A.venueNm" />
															</td>
			                            				</tr>
			                            				<tr>
														...
														<!-- <tr>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.planQty" />
															</td>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.resultTQty" />
															</td>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.targetRate" />
															</td>
															<td class="td-cond-report" colspan="2">
																<fmt:message key="PAY01001A.payRate"/>
															</td>
															<!-- 
															<td id="excPayTpCD_td" class="td-cond-report">
																<fmt:message key="PAY01001A.excPayTpCD" />
															</td>
															 -->
			                            			<!-- 	</tr>
			                            				<tr>
...
<!-- 																&nbsp;<span id="payRate"></span> -->
																<!--  <input type="text" id="payRate" name="payRate" style="width:100px; height:17px; ime-mode:disabled; text-align:right;" maxlength="5" onchange="setPayRate();calculateTpayAmt();" readonly/>
														...
														<tr>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.tpayAmt" />
															</td>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.resultTpCD" />
															</td>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.gsvRate" />
															</td>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.keyman" />
															</td>
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.verifyStateCD" />
															</td>
			                            				...
			                            				<tr>
															...
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.commt" />
															</td>
															<td class="td-report-rborder" colspan="2">
																<input type="text" id="commt" name="commt" style="width:320px; height:17px;">
															</td>
														</tr>
														<tr style="height:100%">
															<td class="td-cond-report">
																<fmt:message key="PAY01001A.verifyErrCommt" />
															</td>
...
<style type="text/css">
    ...
    #grid_rlt .aw-column-5 {width: 100px; text-align:left;}
...
/*     #grid_prd .aw-column-5 {width: 80px; text-align:right;} */
    #grid_prd .aw-column-4 {width: 80px; text-align:right;}
    #grid_prd .aw-column-5 {width: 120px; text-align:right;}
...
// 		getResultWriteDate();
		...
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PAY0100101S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
...
// 	  	if (grid_rlt != null) grid_rlt.clear();
	...
	function Search_dtl() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PAY0100102S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
...
// 	  	if (grid_prd != null) grid_prd.clear();
	...
	function Save() {
		...
		if($("#verifyStateCD").val() != "10" && $("#verifyStateCD").val() != "40" && $("#verifyStateCD").val() != "ERR") {
			alert("<fmt:message key="PAY01001A.msg1"/>");
			return;
		}
		...
		if(targetRate > 120) {
			if($("#excPayTpCD").val() == "") {
				alert("<fmt:message key="PAY01001A.msg3"/>");
				$("#excPayTpCD").focus();
				return;
			}
		}
...
// 			if($("#commt").val() == "") {
// 				alert("<fmt:message key="PAY01001A.msg4"/>");
// 				$("#commt").focus();
// 				return;
// 			}
// 		}
		...
		if($("#activityCD").val() != "20") {
			...
			if(payAmt_keyman != tpayAmt) {
				alert("<fmt:message key="PAY01001A.msg2"/>");
				return;
			}
		}
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/pay01/saveResultWriteVenue_err");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
		table.setParameter("venueCD", $("#selectVenueCD").val());
	...
	*****************************************************/
	...
	var columns_prd = [
		"<fmt:message key="PAY01001A.kindTpCD5"/>"
		, "<fmt:message key="PAY01001A.prdNm"/>"
		, "<fmt:message key="PAY01001A.factoryPrice"/>"
		, "<fmt:message key="PAY01001A.qtyUnitCD"/>"
		//, "<fmt:message key="PAY01001A.planQty"/>"
		//, "<fmt:message key="PAY01001A.rfidQty"/>"
		...
		, "<fmt:message key="PAY01001A.payAmt"/>"
		, "<fmt:message key="PAY01001A.incomeTax"/>"
		, "<fmt:message key="PAY01001A.residentTax"/>"
		, "<fmt:message key="PAY01001A.withholdingTax"/>"
		, "<fmt:message key="PAY01001A.totalAmt"/>"
	];
	var grid_prd = null;
