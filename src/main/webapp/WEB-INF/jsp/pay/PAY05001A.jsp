...
<style type="text/css">
    ...
    .aw-column-30 {width: 70px; text-align:center;}
    .aw-column-31 {width: 100px; text-align:right;}
    .aw-column-32 {width: 70px; text-align:center;}
    .aw-column-33 {width: 120px; text-align:center;}
    .aw-column-34 {width: 70px; text-align:center;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/PAY0500101S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			...
	  			"avgUnitAmt;resultTpCDName;targetRate;payRate;excPayTpCDName;gsvRate;mileageYN;"+
	  			"commt;verifyStateCDName;payStateCDName;payCommt;transferDueDate;transferDate;keymanNm;"+
	  			"payAmt;bankCDName;accountNo;holderNm;rowNum;");
	  	table.setParameter("format",
	  			"str;str;str;str;str;str;"+
	  			"str;str;str;str;str;str;"+
	  			"str;str;str;num;num;"+
	  			"num;str;num;num;str;num;str;"+
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/PAY0500102S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PAY0500101S");
		table.setParameter("rageSphereCD_S", "${params.rageSphereCD}");
	  	table.setParameter("officeCD_S", "${params.officeCD}");
	  	table.setParameter("teamCD_S", "${params.teamCD}");
	  	table.setParameter("territoryCD", "${params.territoryCD}");
		...
		var headerText = [
			...
			, "<fmt:message key="PAY05001A.keymanNm"/>"
			, "<fmt:message key="PAY05001A.payAmt"/>"
			, "<fmt:message key="PAY05001A.bankCDName"/>"
			, "<fmt:message key="PAY05001A.accountNo"/>"
			, "<fmt:message key="PAY05001A.holderNm"/>"
		];
		
		table.setParameter("templateFile", "PAY05001A");
