	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	...
	  	table.setParameter("outParamKey",
	  			...
	  			"bankCDName;accountNo;payApprDate;transferDate;payCommt;"+
	  			"payStateCDName;holderNm;payStateCD;keymanID;bankCD;"+
	  			"rowNum;totalCount;");
...
// 	  	if (grid != null) grid.clear();
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "PAY0400901S");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
	  	table.setParameter("diffNo", $("#diffNo").val());
		table.setParameter("dkmdTpCD", $("#dkmdTpCD_S").val());
	  	table.setParameter("rageSphereCD", $("#rageSphereCD_S").val());
		...
		table.setParameter("templateFile", "PAY04009A");
	...
	*****************************************************/
	var columns = [
		...
		, "<fmt:message key="PAY04007A.transferDate"/>"
		, "<fmt:message key="PAY04007A.payCommt"/>"
		, "<fmt:message key="PAY04007A.payStateCD"/>"
	];
