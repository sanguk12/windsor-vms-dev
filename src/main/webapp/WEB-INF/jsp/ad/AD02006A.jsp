...
<style type="text/css">
    ...
    .aw-column-19 {width: 110px; text-align:left;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/simpleAction/AD0200601S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			...
	  			"payStateName;resultCommt;apprCommt;apprStateName;expccommt;"+
	  			"resultStateName;adHistory;file1;file2;file3;"+
	  			"apprStateCD;resultStateCD;adSupportID;lapprLevelNo;levelNo;"+
	  			"lastApprYN;apprExpc;adSeq;adContractDivCD;file1Cnt;"+
		...
		table.setParameter("empID", "${params.empID}");
	  	...
	  	table.setParameter("adContractDivCD", "30");
		...
		//Paging Parameter - END
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/AD0200602S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "AD0200604S");
		table.setParameter("startDT", $("#yearFromCD_S").val() + $("#monthFromCD_S").val());
		table.setParameter("endDT", $("#yearToCD_S").val() + $("#monthToCD_S").val());
		table.setParameter("empID", "${params.empID}");
	  	table.setParameter("rageSphereCD", $("#rageSphereCD_S").val());
		...
		table.setParameter("templateFile", "AD02006A");
