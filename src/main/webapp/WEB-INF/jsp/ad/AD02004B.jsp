						            		...
						            		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="80%">
                								<colgroup>
			        						 	...
			        						 	<tbody>
													...
													<%--0210  style="display: none;"--%>
													<tr style="display: none;">
															<td  class="group-title" style="border: 0;">
...
<!-- 			<input type="hidden" id="compareEndYm"  name="compareEndYm"/> -->
			...
			<!-- total 여부 -->
			<input type="hidden" id="totalVol2" name="totalVol2" readonly="readonly"/>
		</form>
	</body>
</html>
	...
	function Search(){
		...
		table.setAsync(false);
	  	...
	  	table.setParameter("outParamKey",
	  			...
	  			"requiredADCD3;amt1;amt2;amt3;location1;location2;location3;adProgram;venueActivity1;venueActivity2;venueActivity3;");
	  	table.setParameter("format",
	  			"str;str;str;str;str;"+
	  			"str;str;str;str;str;"+
	  			"str;str;str;str;str;"+
      	...
      	if (rowCount > 0) {
				...
				$("#location1").val(table.getData(34,0));
				$("#location2").val(table.getData(35,0));
				$("#location3").val(table.getData(36,0));
				$("#adProgram").val(table.getData(37,0));
				$("#venueActivity1").val(table.getData(38,0));
				$("#venueActivity2").val(table.getData(39,0));
				$("#venueActivity3").val(table.getData(40,0));
      			settingRequiredAD();
      		}
	}
