	...
	function Search() {
		var table = new AW.XML.Table;
	  	...
	  	table.setParameter("outParamKey",
	  			"adHistoryCDName;apprGrpNm;empID;empNm;apprStateCDName;"+
	  			"apprDate;commt;");
	  	table.setParameter("format",
	  			"str;str;str;str;str;"+
	  			"str;str;");
	  	table.setParameter("adSupportID", "${params.adSupportID}");
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
      		...
      		for (var i=0; i<rowCount; i++) {
      			data[i] = [
      			      table.getData(_col.adHistoryCDName,i)
	...
	*****************************************************/
	var columns = [
		 "<fmt:message key="AD01002C.adHistoryCD"/>"
		, "<fmt:message key="AD01002C.apprGrpNm"/>"
		, "<fmt:message key="AD01002C.empID"/>"
		, "<fmt:message key="AD01002C.empNm"/>"
