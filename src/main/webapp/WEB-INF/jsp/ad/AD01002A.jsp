...
<style type="text/css">
	...
	.aw-column-13 {width: 75px; text-align:left;}
...
<script type="text/javascript">
	...
	function PagingSearch() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/simpleAction/AD0100201S");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("outParamKey",
				...
				"apprExpc;file1Cnt;file2Cnt;file3Cnt;rowNum;");
		// ("outParamKey",
		// "checkbox;contractDivCD;venueCD;venueNM;startDT;"+
	...
	function RequestApp() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/ad01/requestAppResultAD");
		table.setAsync(false);
		table.setRequestMethod("POST");
	...
	function ClearRequestApp() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/ad01/clearRequestAppResultAD");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("adSupportIDs", adSupportIDs);
		table.setParameter("empID", "${params.empID}");
	...
	function Excel() {
		...
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "AD0100204S");
		table.setParameter("startDT", $("#yearFromCD_S").val() + $("#monthFromCD_S").val());
		table.setParameter("endDT", $("#yearToCD_S").val() + $("#monthToCD_S").val());
		table.setParameter("empID", "${params.empID}");
		table.setParameter("rageSphereCD", $("#rageSphereCD_S").val());
		...
		table.setParameter("templateFile", "AD01002A");
