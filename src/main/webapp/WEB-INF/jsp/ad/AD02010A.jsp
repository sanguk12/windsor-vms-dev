...
<style type="text/css">
    ...
    .aw-column-21 {width: 90px; text-align:right;}
    .aw-column-22 {width: 90px; text-align:right;}
    .aw-column-23 {width: 90px; text-align:right;}
    .aw-column-24 {width: 90px; text-align:right;}
    .aw-column-25 {width: 90px; text-align:right;}
    .aw-column-26 {width: 90px; text-align:right;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/simpleAction/AD0201001S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
		table.setParameter("outParamKey",
	  			"adSupportID;eventYm;venueCD;venueNm;rageSphereCDName;"+
	  			"officeCDName;chain;venueGradCDName;venueDivCDName;buCDName;"+
	  			"requiredADCD1Name;amt1;requiredADCD2Name;amt2;requiredADCD3Name;"+
	  			"amt3;contractStateCDName;payStateCDName;prdCDName;apAmt;" + 
	  			"posmAmt;gsv;prdTotalAmt;adSdxDep;apAmtPerGsv;" +
	  			"resultGsv;resultQty;rowNum;totalCount;"
	  			);
      	...
      	if (rowCount > 0) {
      		for (var i = 0; i < rowCount; i++) {
      			...
      			data[i] = [
					...
					, table.getData(_col.contractStateCDName,i)
					, table.getData(_col.payStateCDName,i)
					, table.getData(_col.prdCDName,i)
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "AD0201002S");
		table.setParameter("startDT", $("#yearFromCD_S").val() + $("#monthFromCD_S").val());
		table.setParameter("endDT", $("#yearToCD_S").val() + $("#monthToCD_S").val());
		table.setParameter("empID", "${params.empID}");
	  	table.setParameter("rageSphereCD", $("#rageSphereCD_S").val());
		...
		var headerText = [
			...
			, "<fmt:message key="AD02010A.officeCD"/>"
			, "<fmt:message key="AD02010A.chain"/>"
			, "<fmt:message key="AD02010A.venueGradCD"/>"
			, "<fmt:message key="AD02010A.venueDivCD"/>"
			, "<fmt:message key="AD02010A.buCDName"/>"
			, "<fmt:message key="AD02010A.requiredADCD1Name"/>"
			, "<fmt:message key="AD02010A.amt"/>"
			, "<fmt:message key="AD02010A.requiredADCD2Name"/>"
			, "<fmt:message key="AD02010A.amt"/>"
			, "<fmt:message key="AD02010A.requiredADCD3Name"/>"
			, "<fmt:message key="AD02010A.amt"/>"
			, "<fmt:message key="AD02010A.contractStateCD"/>"
			, "<fmt:message key="AD02010A.payStateCD"/>"
			, "<fmt:message key="AD02010A.brand"/>"
			, "<fmt:message key="AD02010A.apAmt"/>"
			, "<fmt:message key="AD02010A.posmAmt"/>"
			, "<fmt:message key="AD02010A.gsv"/>"
			, "<fmt:message key="AD02010A.prdTotalAmt"/>"
			, "<fmt:message key="AD02010A.adSdxDep"/>"
			, "<fmt:message key="AD02010A.apAmtPerGsv"/>"
			, "<fmt:message key="AD02010A.resultGsv"/>"
			, "<fmt:message key="AD02010A.resultTQty"/>"
		];
		
		table.setParameter("templateFile", "AD02010A");
