...
<script type="text/javascript">
	...
	function PagingSearch() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/simpleAction/AD0200101S");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("outParamKey",
				...
				"lapprLevelNo;levelNo;lastApprYN;apprExpc;file1Cnt;"+
		...
		if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/AD0200102S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Approval() {
		...
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/ad02/approvalResultAD");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("empID", "${params.empID}");
	...
	function Reject() {
		...
		table.setURL("${contextPath}/service/ad02/rejectResultAD");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("empID", "${params.empID}");
		table.setParameter("venueCDs", venueCDs);
	...
	function Excel() {
		...
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "AD0200104S");
		table.setParameter("startDT", $("#yearFromCD_S").val() + $("#monthFromCD_S").val());
		table.setParameter("endDT", $("#yearToCD_S").val() + $("#monthToCD_S").val());
		table.setParameter("empID", "${params.empID}");
		table.setParameter("rageSphereCD", $("#rageSphereCD_S").val());
		...
		table.setParameter("templateFile", "AD02001A");
