						        		...
						        		<tbody>
				                            <tr>
												...
												<td class="td-input">
				                                 ...
				                                 <td class="td-cond">
													<fmt:message key="RLT02001A.activityCD" />
												</td>
												<td class="td-input">
											...
											<tr>
												<td class="td-cond">
													<fmt:message key="RLT02001A.segmentCD" />
												</td>
												<td class="td-input">
				                                ...
				                                <td class="td-cond">
													<fmt:message key="RLT02001A.subSegmentCD" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
												...
												<td class="td-cond">
													<fmt:message key="RLT02001A.apprStateCD_emp" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="RLT02001A.payRate_YN" />
												</td>
												<td class="td-input">
				                                ...
				                                <td class="td-cond">
													<fmt:message key="RLT02001A.excPayTpCD_YN" />
												</td>
												<td class="td-input">
												...
												<td class="td-cond">
													<fmt:message key="RLT02001A.gsvRate_YN" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="RLT02001A.plnRltCompareYN" />
												</td>
...
<style type="text/css">
    ...
    .aw-column-13 {width: 130px; text-align:right;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/RLT0200101S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/RLT0200106S");
			table.setAsync(false);
			table.setRequestMethod("POST");
		...
		for(var i=0; i<index.length; i++) {
			if (grid.getCellValue(_col.checkbox, index[i])) {
				...
				if(grid.getCellText(_col.apprStateCD_emp, index[i]) != "20") {
					alert("<fmt:message key="RLT02001A.msg1"/>");
					return;
				}
			}
		}
		
		if(!confirm("<fmt:message key="RLT02001A.msg2"/>")) {
       		return;
       	}
		
		var table = new AW.XML.Table;
		table.setURL("${contextPath}/service/rlt02/approvalResultVenue");
		table.setAsync(false);
		table.setRequestMethod("POST");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
		table.setParameter("empID", "${params.empID}");
	...
	function Reject() {
		...
		for(var i=0; i<index.length; i++) {
			if (grid.getCellValue(_col.checkbox, index[i])) {
				//개별승인상태가 승인요청일 경우만 가능
				if(grid.getCellText(_col.apprStateCD_emp, index[i]) != "20") {
					alert("<fmt:message key="RLT02001A.msg3"/>");
					return;
				}
				if(grid.getCellText(_col.apprCommt, index[i]) == "") {
					alert("<fmt:message key="RLT02001A.msg4"/>");
		...
		if(!confirm("<fmt:message key="RLT02001A.msg5"/>")) {
       		return;
       	}
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "RLT0200105S");
		table.setParameter("eventYM", $("#yearCD_S").val()+$("#monthCD_S").val());
	  	table.setParameter("empID", "${params.empID}");
	  	table.setParameter("diffNo", $("#diffNo").val());
		table.setParameter("apprTpID", $("#apprTpID").val());
		...
		var headerText = [
			"<fmt:message key="RLT02001A.programCD"/>"
			, "<fmt:message key="RLT02001A.activityCD"/>"
			, "<fmt:message key="RLT02001A.rageSphereCD"/>"
			, "<fmt:message key="RLT02001A.officeCD"/>"
			, "<fmt:message key="RLT02001A.empNm"/>"
			, "<fmt:message key="RLT02001A.venueCD"/>"
			, "<fmt:message key="RLT02001A.venueNm"/>"
			, "<fmt:message key="RLT02001A.venueGradCD"/>"
			, "<fmt:message key="RLT02001A.segmentCD"/>"
			, "<fmt:message key="RLT02001A.subSegmentCD"/>"
			, "<fmt:message key="RLT02001A.addrTpCD1"/>"
			, "<fmt:message key="RLT02001A.addrTpCD2"/>"
			, "<fmt:message key="RLT02001A.tpayAmt"/>"
			, "<fmt:message key="RLT02001A.resultTQty"/>"
			, "<fmt:message key="RLT02001A.avgUnitAmt"/>"
			, "<fmt:message key="RLT02001A.resultTpCDName"/>"
			, "<fmt:message key="RLT02001A.targetRate"/>"
			, "<fmt:message key="RLT02001A.payRate"/>"
			, "<fmt:message key="RLT02001A.excPayTpCDName"/>"
			, "<fmt:message key="RLT02001A.gsvRate"/>"
			, "<fmt:message key="RLT02001A.commt"/>"
			, "<fmt:message key="RLT02001A.apprCommt"/>"
			, "<fmt:message key="RLT02001A.apprStateCD_emp"/>"
			, "<fmt:message key="RLT02001A.apprStateCD"/>"
			, "<fmt:message key="RLT02001A.kindTpCD5"/>"
			, "<fmt:message key="RLT02001A.prdNm"/>"
			, "<fmt:message key="RLT02001A.factoryPrice"/>"
			, "<fmt:message key="RLT02001A.qtyUnitCD"/>"
			, "<fmt:message key="RLT02001A.planQty"/>"
			, "<fmt:message key="RLT02001A.resultQty"/>"
			, "<fmt:message key="RLT02001A.resultUnitAmt"/>"
			, "<fmt:message key="RLT02001A.payAmt"/>"
		];
		
		table.setParameter("templateFile", "RLT02001A");
	...
	*****************************************************/
	var columns = [
		...
		, "<fmt:message key="RLT02001A.addrTpCD1"/>"
		, "<fmt:message key="RLT02001A.addrTpCD2"/>"
		, "<fmt:message key="RLT02001A.planAmtStd"/>"
		, "<fmt:message key="RLT02001A.tpayAmt"/>"
		, "<fmt:message key="RLT02001A.resultTQty"/>"
		, "<fmt:message key="RLT02001A.avgUnitAmt"/>"
		, "<fmt:message key="RLT02001A.resultTpCDName"/>"
