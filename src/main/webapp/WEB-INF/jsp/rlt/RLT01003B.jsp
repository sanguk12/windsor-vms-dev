	...
	****************************************/
	...
	function Search() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/RLT0100308S");
...
// 	  	if (grid != null) grid.clear();
	...
	*****************************************************/
	var columns = [
   		"<fmt:message key="RLT01003B.apprGrpNm"/>"
   		, "<fmt:message key="RLT01003B.empID"/>"
   		, "<fmt:message key="RLT01003B.empNm"/>"
   		, "<fmt:message key="RLT01003B.apprStateCD"/>"
   		, "<fmt:message key="RLT01003B.apprDate"/>"
   		, "<fmt:message key="RLT01003B.commt"/>"
	];
