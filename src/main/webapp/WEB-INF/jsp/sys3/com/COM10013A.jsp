...
<script type="text/javascript">
	...
	****************************************/
	...
	function Choice() {
		...
		var data = {
			"orgCD":grid.getCellText(0, grid.getCurrentRow()),
			"orgName":grid.getCellText(1, grid.getCurrentRow()),
			"orgID":grid.getCellText(3, grid.getCurrentRow())
		};
	...
	function Search() {
		...
		var table = new AW.XML.Table;	  
	  	...
	  	table.setParameter("queryKey","commonservice.common.organizationPopup.select");
	  	table.setParameter("outParamKey","orgCD;orgName;orgID;");
	  	//조직코드;조직명;조직ID;
