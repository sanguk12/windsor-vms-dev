...
<!-- ActiveWidgets Module - START -->
	...
	<script type="text/javascript" src="${contextPath}/scripts/aw/runtime/lib/aw-2.6.4.js" ></script>
...
<!-- Sign Module - START -->
	...
	<script type="text/javascript" src="${contextPath}/scripts/jquery.signaturepad.min.js"></script>
    <link rel="stylesheet" type="text/css" href="${contextPath}/scripts/jquery/ui/css/humanity/jquery.signaturepad.css" />	
    <link rel="stylesheet" type="text/css" href="${contextPath}/css/mobile/mobile.css" />	
	<script type="text/javascript" src="${contextPath}/scripts/flashcanvas.js"></script>
