					        		...
					        		<div id="tab1">
		                        		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px;">
		                            		...
		                            		<tr>
				                                ...
				                                <td class="td-input">
				                                    <input type="password" id="passwd" name="passwd" style="width:100px; maxlength="20" class="input-readonly" readonly />
				                                    <script type="text/javascript">
					                                    ...
					                                    initPW.onControlClicked = function(event){
					                                    	...
					                                    	if (confirm("<fmt:message key="CMP01008A.msg13"/>")) {
						                                        ...
						                                        table.setURL("${contextPath}/service/user/initPassword");
						                                        table.setAsync(false);
						                                        table.setRequestMethod("POST");
						                                        table.setParameter("userID", $("#userID").val());
						                                        table.setParameter("passwd", $("#userID").val());
						                                        table.request();
					                                    ...
					                                    var unlock = new AW.UI.Button;
					                                    unlock.setControlText("<fmt:message key="button.Unlock" />");
					                                    document.write(unlock);
					                                    
					                                    unlock.onControlClicked = function(event){
					                                    	if (!$("#userID").attr("readonly")){
					                                            alert("<fmt:message key="CMP01008A.msg15"/>");
					                                            return;
					                                        }
					                                    	
					                                    	if (confirm("<fmt:message key="CMP01008A.msg16"/>")) {
						                                        var table = new AW.XML.Table;
						                                        table.setURL("${contextPath}/service/user/unlockPassword");
						                                        table.setAsync(false);
						                                        table.setRequestMethod("POST");
						                                        table.setParameter("userID", $("#userID").val());
						                                        table.request();
						                                        ...
						                                        if (table.getData(0,0) == 'S') {
						                                        	confirm("<fmt:message key="CMP01008A.msg17"/>")
						                                        }
						                                        else {
						                                           alert(table.getData(1,0));
						                                        }
...
<script type="text/javascript">
	...
	*/
    ...
    //중복확인 버튼 생성
     ...
     overLap.onControlClicked = function(event){
        ...
        if ($("#userID").val().length < 5){
        	alert("<fmt:message key="CMP01008A.msg18"/>");
        	$("#userID").focus();
            return;
        }
    ...
    function New() {
    	$("#userID").focus();
        $("#userID").removeClass("input-readonly");
    ...
    *****************************************************/
    ...
    function createGrid() {
        ...
        grid.onRowDoubleClicked = function(event, row){
	        ...
	        table.setAsync(false);
	        table.setRequestMethod("POST");
	        table.setParameter("outParamKey","userID;userName;passwd;useYN;mnuConstructID;grpID;authLevelCD;themeCD;"+
	        		"timezoneCD;languageCD;dateFormatCD;localeCD;");
	        ...
	        if (rowCount > 0) {
	            ...
	            $("#userID").addClass("input-readonly");
	            $("#userID").attr("readonly", true);
                ...
                $("#themeCD").val(table.getData(7,0));
                $("#timezoneCD").val(table.getData(8,0));
                $("#languageCD").val(table.getData(9,0));
                $("#dateFormatCD").val(table.getData(10,0));
                $("#localeCD").val(table.getData(11,0));
