...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/ANL0100601S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			...
	  			"planUnitAmt;resultQty;resultUnitAmt;guidAmt;payAmt;gsvRate;euPlanQty;"+
	  			"sdxTpCDName;targetRate;rowNum;");
...
// 	  	if (grid != null) grid.clear();
		...
		if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/ANL0100602S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "ANL0100601S");
		table.setParameter("rageSphereCD_S", "${params.rageSphereCD}");
	  	table.setParameter("officeCD_S", "${params.officeCD}");
	  	table.setParameter("teamCD_S", "${params.teamCD}");
	  	table.setParameter("territoryCD", "${params.territoryCD}");
		...
		var headerText = [
			...
			, "<fmt:message key="ANL01001A.resultQty"/>"
			, "<fmt:message key="ANL01001A.resultUnitAmt"/>"
			, "<fmt:message key="ANL01001A.resultGuidAmt"/>"
			, "<fmt:message key="ANL01001A.payAmt"/>"
			, "<fmt:message key="ANL01001A.gsvRate"/>"
			, "<fmt:message key="ANL01001A.euResultQty"/>"
			, "<fmt:message key="ANL01001A.sdxTpCDName"/>"
			, "<fmt:message key="ANL01001A.targetRate"/>"
		];
		
		table.setParameter("templateFile", "ANL01006A");
