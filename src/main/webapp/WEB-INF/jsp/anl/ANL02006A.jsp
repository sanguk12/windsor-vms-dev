                    		...
                    		<tr>
                    			<td class="tb-border">
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
										...
										<tbody>
											<tr>
												<td class="td-cond-required"><fmt:message key="ANL02006A.esltTbInfo"/>
												</td>
												<td class="td-input">
												...
												<td class="td-cond-required"><fmt:message key="ANL02006A.branch"/>
												</td>
												<td class="td-input">
											...
											<tr>
												<td class="td-cond"><fmt:message key="ANL02006A.dataUploadYn"/>
												</td>
												<td class="td-input" colspan="3">
													...
													<span id="msg" style="color: red;font: bold;">
														<fmt:message key="ANL02006A.dataUploadMsg"/>
													</span>
			                               		</td>
											</tr>
											<tr>
...
<script language="javascript">
	...
	function refresh_esltTbInfo() {
    	...
    	table.setURL("${contextPath}/service/simpleAction/ANL0200601S");
	...
	function refresh_branch() {
		...
		var table = new AW.XML.Table;
    	table.setURL("${contextPath}/service/simpleAction/ANL0200602S");
        table.setAsync(false);
        table.setRequestMethod("POST");
	...
	function refresh_dataUpload() {
		...
		var table = new AW.XML.Table;
    	table.setURL("${contextPath}/service/simpleAction/ANL0200603S");
        table.setAsync(false);
        table.setRequestMethod("POST");
...
<script type="text/javascript">
	...
	****************************************/
	function DownloadToInput() {
		...
		form.action = "${contextPath}/service/anl02/downloadFile_ANL02006A?"+
	...
	function Save() {
		...
		if($("#dataUploadUseYn_h").val() == "N"){
			alert("<fmt:message key="ANL02006A.msg4" />")
			return;
		}
		...
		if($("#esltTbInfo").val() == "23"){
			...
			var table = new AW.XML.Table;
			table.setURL("${contextPath}/service/anl02/save_ANL02006A");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	**********************************************/
	...
	function upload() {
		...
		if (fileID != null && fileID != "") {
	    	showLoading();
	    	uploader.upload(fileID, "${contextPath}/service/anl02/extract_ANL02006A_Xls"
	    			, "POST"
