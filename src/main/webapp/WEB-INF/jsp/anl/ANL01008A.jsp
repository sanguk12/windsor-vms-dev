									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
						        		...
						        		<tbody>
											...
											<tr>
												...
												<td class="td-cond">
													<fmt:message key="ANL01008A.activityCD" />
												</td>
												<td class="td-input">
				                            ...
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="ANL01008A.rageSphereCD" />
												</td>
												<td class="td-input">
				                                ...
				                                <td class="td-cond">
													<fmt:message key="ANL01008A.officeCD" />
												</td>
...
<style type="text/css">
    ...
    .aw-column-25 {width: 100px; text-align:left;}
    ...
    .aw-column-29 {width: 80px; text-align:right;}
    ...
    .aw-column-33 {width: 100px; text-align:right;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/ANL0100801S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			"eventYM;storeBrandFGNm;diffNo;programCDName;activityCDName;dkmdTpCDName;"+
	  			"rageSphereCDName;officeCDName;empNm;venueCD;venueNm;"+
	  			"wsSapCD;wsSapCDName;venueGradCDName;segmentCDName;subSegmentCDName;"+
	  			//"addrTpCD1Name;addrTpCD2Name;addrTpCD3Name;targetRate;payRate;excPayTpCDName;"+
	  			"addrTpCD1Name;addrTpCD2Name;addrTpCD3Name;addrTpCD4Name;targetRate;"+
	  			"gsvRate;kindTpCD5Name;kindTpCD2Name;prdNm;planQty;planUnitAmt;"+
	  			"resultQty;resultUnitAmt;payAmt;finalUnitAmt;euResultQty;"+
	  			"rowNum;");
	  	table.setParameter("format",
	  			"str;str;str;str;str;str;"+
	  			"str;str;str;str;str;"+
	  			"str;str;str;str;str;"+
	  			//"str;str;str;num;num;str;"+
	  			"str;str;str;str;num;"+
	  			"num;str;str;str;num;num;"+
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/ANL0100802S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		*/
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "ANL0100801S");
		table.setParameter("rageSphereCD_S", "${params.rageSphereCD}");
	  	table.setParameter("officeCD_S", "${params.officeCD}");
	  	table.setParameter("teamCD_S", "${params.teamCD}");
	  	table.setParameter("territoryCD", "${params.territoryCD}");
		...
		var headerText = [
			"<fmt:message key="ANL01008A.eventYM"/>"
			, "<fmt:message key="ANL01008A.storeBrandFG"/>"
			, "<fmt:message key="ANL01008A.diffNo"/>"
			, "<fmt:message key="ANL01008A.programCD"/>"
			, "<fmt:message key="ANL01008A.activityCD"/>"
			, "<fmt:message key="ANL01008A.dkmdTpCD"/>"
			, "<fmt:message key="ANL01008A.rageSphereCD"/>"
			, "<fmt:message key="ANL01008A.officeCD"/>"
			, "<fmt:message key="ANL01008A.empNm"/>"
			, "<fmt:message key="ANL01008A.venueCD"/>"
			, "<fmt:message key="ANL01008A.venueNm"/>"
			, "<fmt:message key="ANL01008A.wsSapCD"/>"
			, "<fmt:message key="ANL01008A.wsSapCDName"/>"
			, "<fmt:message key="ANL01008A.venueGradCD"/>"
			, "<fmt:message key="ANL01008A.segmentCD"/>"
			, "<fmt:message key="ANL01008A.subSegmentCD"/>"
			, "<fmt:message key="ANL01008A.addrTpCD1"/>"
			, "<fmt:message key="ANL01008A.addrTpCD2"/>"
			, "<fmt:message key="ANL01008A.addrTpCD3"/>"
			, "<fmt:message key="ANL01008A.addrTpCD4"/>"
			, "<fmt:message key="ANL01008A.targetRate"/>"
			//, "<fmt:message key="ANL01008A.payRate"/>"
			//, "<fmt:message key="ANL01008A.excPayTpCDName"/>"
			, "<fmt:message key="ANL01008A.gsvRate"/>"
			, "<fmt:message key="ANL01008A.kindTpCD5Name"/>"
			, "<fmt:message key="ANL01008A.kindTpCD2Name"/>"
			, "<fmt:message key="ANL01008A.prdNm"/>"
			, "<fmt:message key="ANL01008A.planQty"/>"
			, "<fmt:message key="ANL01008A.planUnitAmt"/>"
			, "<fmt:message key="ANL01008A.resultQty"/>"
			, "<fmt:message key="ANL01008A.resultUnitAmt"/>"
			, "<fmt:message key="ANL01008A.payAmt"/>"
			, "<fmt:message key="ANL01008A.finalUnitAmt"/>"
			, "<fmt:message key="ANL01008A.euResultQty"/>"
		];
		
		table.setParameter("templateFile", "ANL01008A");
