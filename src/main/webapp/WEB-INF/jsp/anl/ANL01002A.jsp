...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/ANL0100201S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			...
	  			"addrTpCD1Name;addrTpCD2Name;addrTpCD3Name;addrTpCD4Name;"+
	  			"gsvRate;kindTpCD5Name;kindTpCD2Name;prdNm;"+
	  			"resultQty;resultUnitAmt;payAmt;finalUnitAmt;"+
	  			"incomeTax;residentTax;withholdingTax;totalAmt;inputQty;inputAmt;euResultQty;" +
	  			"verifyStateCDName;rowNum;");
...
// 	  	if (grid != null) grid.clear();
      	...
      	if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/ANL0100202S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "ANL0100201S");
		table.setParameter("rageSphereCD_S", "${params.rageSphereCD}");
	  	table.setParameter("officeCD_S", "${params.officeCD}");
	  	table.setParameter("teamCD_S", "${params.teamCD}");
	  	table.setParameter("territoryCD", "${params.territoryCD}");
		...
		var headerText = [
			"<fmt:message key="ANL01002A.eventYM"/>"
			, "<fmt:message key="ANL01002A.diffNo"/>"
			, "<fmt:message key="ANL01002A.programCD"/>"
			, "<fmt:message key="ANL01002A.activityCD"/>"
			, "<fmt:message key="ANL01002A.dkmdTpCD"/>"
			, "<fmt:message key="ANL01002A.rageSphereCD"/>"
			, "<fmt:message key="ANL01002A.officeCD"/>"
			...
			//, "<fmt:message key="ANL01002A.targetRate"/>"
			//, "<fmt:message key="ANL01002A.payRate"/>"
			//, "<fmt:message key="ANL01002A.excPayTpCDName"/>"
			, "<fmt:message key="ANL01002A.gsvRate"/>"
			, "<fmt:message key="ANL01002A.kindTpCD5Name"/>"
			, "<fmt:message key="ANL01002A.kindTpCD2Name"/>"
			, "<fmt:message key="ANL01002A.prdNm"/>"
			//, "<fmt:message key="ANL01002A.planQty"/>"
			, "<fmt:message key="ANL01002A.resultQty"/>"
			//, "<fmt:message key="ANL01002A.planUnitAmt"/>"
			, "<fmt:message key="ANL01002A.resultUnitAmt"/>"
			, "<fmt:message key="ANL01002A.payAmt"/>"
			, "<fmt:message key="ANL01002A.finalUnitAmt"/>"
			, "<fmt:message key="ANL01002A.incomeTax"/>"
			, "<fmt:message key="ANL01002A.residentTax"/>"
			, "<fmt:message key="ANL01002A.withholdingTax"/>"
			, "<fmt:message key="ANL01002A.totalAmt"/>"
			, "<fmt:message key="ANL01002A.inputQty"/>"
			, "<fmt:message key="ANL01002A.inputAmt"/>"
			, "<fmt:message key="ANL01002A.euResultQty"/>"
			, "<fmt:message key="PAY02001A.verifyStateCDName"/>"
			
		];
		
		table.setParameter("templateFile", "ANL01002A");
