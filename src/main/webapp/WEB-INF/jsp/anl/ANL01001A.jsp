                    			...
                    			<td class="tb-border">
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:#e1dcbe solid 1px; table-layout:fixed;">
						        		...
						        		<tbody>
				                            <tr>
				                            	<td class="td-cond">
													<fmt:message key="ANL01001A.programCD" />
												</td>
												<td class="td-input">
...
<style type="text/css">
    ...
    .aw-column-16 {width: 120px; text-align:center;}
    .aw-column-17 {width: 150px; text-align:center;}
...
<script type="text/javascript">
	...
	****************************************/
	...
	function PagingSearch() {
		var table = new AW.XML.Table;
	  	table.setURL("${contextPath}/service/simpleAction/ANL0100101S");
	  	table.setAsync(false);
	  	table.setRequestMethod("POST");
	  	table.setParameter("outParamKey",
	  			"eventYM;programCDName;activityCDName;dkmdTpCDName;rageSphereCDName;"+
	  			"officeCDName;empNm;venueCD;venueNm;wsSapCD;"+
	  			"wsSapCDName;venueGradCDName;segmentCDName;subSegmentCDName;addrTpCD1Name;"+
	  			"addrTpCD2Name;addrTpCD3Name;addrTpCD4Name;threeMonthAvgRate;gsvRate;"+
	  			"kindTpCD5Name;kindTpCD2Name;prdNm;planQty;planUnitAmt;"+
	  			"payAmt;euPlanQty;rowNum;");
...
// 	  	if (grid != null) grid.clear();
		...
		if (rowCount > 0) {
			...
			table.setURL("${contextPath}/service/simpleAction/ANL0100102S");
			table.setAsync(false);
			table.setRequestMethod("POST");
	...
	function Excel() {
		...
		table.setAsync(false); 
		table.setRequestMethod("POST");
		table.setParameter("queryKey", "ANL0100101S");
		table.setParameter("rageSphereCD_S", "${params.rageSphereCD}");
	  	table.setParameter("officeCD_S", "${params.officeCD}");
	  	table.setParameter("teamCD_S", "${params.teamCD}");
	  	table.setParameter("territoryCD", "${params.territoryCD}");
		...
		var headerText = [
			...
			, "<fmt:message key="ANL01001A.threeMonthAvgRate"/>"
		...
		table.setParameter("templateFile", "ANL01001A");
